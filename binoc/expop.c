...
extern Widget toplevel, stepform,bwframe,aframe, oform,otoggle_box;
...
static Widget cmdlabel, comitem, quick,estop,maintoggle_box,nrepsw;
static Widget penidw,xpenid,ypenid,protitem = NULL;
static Widget sliderbox = NULL, expmean[2], expcycle[2], stimcycle;
unsigned expseed = 0;
...
static Sliderdat stimsliderprops[] ={
  { 0.0, 360.0, 0, ORIENTATION, NULL },
  { 0.0, 10.0, 2, SF,NULL },
  { 0.0, 10.0, 2, TF,NULL },
  { -1.0, 1.0, 3, SETCONTRAST,NULL },
  { 0.0, 360 , 0, DISP_P,NULL },
  { -0.5, 0.5, 2, DISP_X,NULL },
  { 0.0, 1.0, 2, DISP_Y,NULL },
  { 0.0, 10.0, 2, STIM_WIDTH,NULL },
  { 0.0, 10.0, 2, STIM_HEIGHT,NULL },
  { 0.0, 10.0, 2, STIM_SIZE,NULL },
  { 0.0, 10.0, 2, BACK_SIZE,NULL },
  { 0, 50, 1, DOT_VELOCITY,NULL },
  { 0.0, 10.0, 2, SF2,NULL },
  { 0.0, 10.0, 2, TF2,NULL },
  { -1.0, 1.0, 3, CONTRAST2,NULL },
  { -180.0, 180, 0, PLAID_ANGLE,NULL },
  { 0.0, 10.0, 2, SETZXOFF,NULL },
  { 0.0, 10.0, 2, SETZYOFF,NULL },
  { 0.0, 10.0, 2, ORTHOG_POS,NULL },
  { -10.0, 10.0, 1, FIXPOS_X,NULL },
  { -10.0, 10.0, 1, FIXPOS_Y,NULL },
  { 0.0, 50.0, 0, XSAMPLES,NULL },
  { 0, 1.0, 2, SETFIXCOLOR,NULL },
  { 0, 40.0, 3, SETFIXSIZE,NULL },
  {0, 10.0, 2, VSACCADE_VALUE, NULL },
  {0, 1.0, 2, PREPERIOD_CODE, NULL },
  {0, 1.0, 2, ISI_CODE, NULL },
  { 0.0, 10.0, 2, SD_X,NULL },
  { 0.0, 10.0, 2, CONTRAST_DIFF,NULL },
  { 0.0, 10.0, 2, ORIENTATION_DIFF,NULL },
  { 0.0, 10.0, 2, SF_DIFF,NULL },
  { 0.0, 1.0, 2, SETCLEARCOLOR,NULL },
  { 0.0, 0.5, 3, DEPTH_MOD, NULL },
  { 0.0, 0.5, 3, DISP_GRAD, NULL },
  { 0.0, 360.0, 0, ORI_LEFT, NULL },
  { 0.0, 16, 2, SF_LEFT, NULL },
  { 0.0, 500, 0, REWARD_SIZE, NULL },
  { 0.0, 144, 0, NFRAMES_CODE, NULL },
  { 0.0, 1.0, 2, SETBACKCOLOR, NULL },
	NULLPROP,
};

/*
static Sliderdat stimsliderprops[] ={
	{ 0.0, 360.0, 0, ORIENTATION, "Orientation"},
	{ 0.0, 10.0, 2, SF,"SF (cpd)"},
	{ 0.0, 10.0, 2, TF,"TF (Hz)"},
	{ -1.0, 1.0, 3, SETCONTRAST,"Contrast"},
	{ 0.0, 360 , 0, DISP_P,"Disparate Phase"},
	{ -0.5, 0.5, 2, DISP_X,"Disparate Position"},
	{ 0.0, 1.0, 2, DISP_Y,"Vertical Diparity"},
	{ 0.0, 10.0, 2, STIM_WIDTH,"Width"},
	{ 0.0, 10.0, 2, STIM_HEIGHT,"Height"},
	{ 0.0, 10.0, 2, STIM_SIZE,"Size"},
	{ 0.0, 10.0, 2, BACK_SIZE,"Back Size"},
	{ 0, 50, 1, DOT_VELOCITY,"Speed"},
	{ 0.0, 10.0, 2, SF2,"SF2 (cpd)"},
	{ 0.0, 10.0, 2, TF2,"TF2 (Hz)"},
	{ -1.0, 1.0, 3, CONTRAST2,"Contrast 2"},
	{ -180.0, 180, 0, PLAID_ANGLE,"Plaid Angle"},
	{ 0.0, 10.0, 2, SETZXOFF,"X offset"},
	{ 0.0, 10.0, 2, SETZYOFF,"Y offset"},
	{ 0.0, 10.0, 2, ORTHOG_POS,"Ortho Pos"},
	{ -10.0, 10.0, 1, FIXPOS_X,"Fixation X"},
	{ -10.0, 10.0, 1, FIXPOS_Y,"Fixation Y"},
	{ 0.0, 50.0, 0, XSAMPLES,"X Sampling"},
	{ 0, 1.0, 2, SETFIXCOLOR,"Fix Color"},
	{ 0, 40.0, 3, SETFIXSIZE,"Fix Size"},
	{0, 10.0, 2, VSACCADE_VALUE, "V Saccade size"},
	{0, 1.0, 2, PREPERIOD_CODE, "PrePeriod"},
	{0, 1.0, 2, ISI_CODE, "ISI"},
	{ 0.0, 10.0, 2, SD_X,"Sigma X"},
	{ 0.0, 10.0, 2, CONTRAST_DIFF,"Contrast diff"},
	{ 0.0, 10.0, 2, ORIENTATION_DIFF,"Orientation diff"},
	{ 0.0, 10.0, 2, SF_DIFF,"SF diff"},
	{ 0.0, 1.0, 2, SETCLEARCOLOR,"Off Color"},
	{ 0.0, 0.5, 3, DEPTH_MOD, "Depth mod"},
	{ 0.0, 0.5, 3, DISP_GRAD, "Depth Grad"},
	{ 0.0, 360.0, 0, ORI_LEFT, "Left Ori"},
	{ 0.0, 16, 2, SF_LEFT, "Left SF"},
	{ 0.0, 500, 0, REWARD_SIZE, "Reward Size"},
	{ 0.0, 144, 0, NFRAMES_CODE, "N of Frames"},
	{ 0.0, 1.0, 2, SETBACKCOLOR, "Background Color"},
	NULLPROP,
};
...
static Fpslider *expslider,*allfps[NALLSLIDERS];
...
#define POPDOWNI 8
static MenuItem penlog_menu[] = {
	{ "Reload Depths", handle_penbuttons, (void *)RELOADDEPTHBUTTON, (MenuItem *)NULL },
	{ "Refresh Text", handle_penbuttons, (void *)REFRESHBUTTON, (MenuItem *)NULL },
	NULL,
};

static MenuItem clear_menu[] = {
	{ "ClearScreen", expbuttons, (void *)CLEAR_SCREEN, (MenuItem *)NULL },
	{ "Clear Lines", expbuttons, (void *)CLEAR_LINES, (MenuItem *)NULL },
	{ "Clear Options", expbuttons, (void *)CLEAR_OPTIONS, (MenuItem *)NULL },
	{ "Clear Plot", expbuttons, (void *)CLEAR_EXPT_ONLY, (MenuItem *)NULL },
	{ "Clear psych", expbuttons, (void *)CLEAR_PSYCHDATA, (MenuItem *)NULL },
	{ "Store State", expbuttons, (void *)STORE_STATE, (MenuItem *)NULL },
	{ "Restore State", expbuttons, (void *)RESTORE_STATE, (MenuItem *)NULL },
	{ "Place Plot", expbuttons, (void *)PLACE_PLOT, (MenuItem *)NULL },
	{ "Print Plot", expbuttons, (void *)PRINT_PLOT, (MenuItem *)NULL },
	{ "Panel", expbuttons, (void *)POPDOWN_PANEL, (MenuItem *)NULL },
	{ "Update Panel", expbuttons, (void *)UPDATE_PANEL, (MenuItem *)NULL },
	{ "Edit Expval", expbuttons, (void *)EDIT_EXPVALS, (MenuItem *)NULL },
	{ "Edit Expval 2", expbuttons, (void *)EDIT_EXP2VALS, (MenuItem *)NULL },
	{ "Show Trials", expbuttons, (void *)SHOW_TRIALCOUNT, (MenuItem *)NULL },
	{ "Show All Expts", expbuttons, (void *)POPUP_EXPTS, (MenuItem *)NULL },
	{ "Edit Exp menus", expbuttons, (void *)EDIT_EXPMENUS, (MenuItem *)NULL },
//	{ "Upload Uff", handle_pushbuttons, (void *)UPLOAD_CODE, (MenuItem *)NULL },
	{ "Freeze", set_run, "freeze", (MenuItem *)NULL },
	{ "Step", set_run, "step", (MenuItem *)NULL },
//	{ "Test Rds", handle_pushbuttons, (void *)(TEST_BUTTON), (MenuItem *)NULL },
	{ "Test", handle_pushbuttons, (void *)(TEST_BUTTON), (MenuItem *)NULL },	
	{ "Check State", handle_pushbuttons, (void *)(QUERY_STATE), (MenuItem *)NULL },
	{ "Clear Softoff", handle_pushbuttons, (void *)(CLEAR_SOFTOFF), (MenuItem *)NULL },
	{ "Null Softoff", handle_pushbuttons, (void *)(NULL_SOFTOFF), (MenuItem *)NULL },	
	{ "Undo Null Softoff", handle_pushbuttons, (void *)(UNDO_NULL_SOFTOFF), (MenuItem *)NULL },
	{ "Centre Stimulus", handle_pushbuttons, (void *)(CENTRE_STIM_ON_RF), (MenuItem *)NULL },
	{ "Copy Online Files", handle_pushbuttons, (void *)(COPY_ONLINE), (MenuItem *)NULL },
	{ "Remember RF", handle_pushbuttons, (void *)(SAVE_RF), (MenuItem *)NULL },
	{ "Pause Expt", handle_pushbuttons, (void *)(PAUSE_EXPT), (MenuItem *)NULL },
	{ "Resume Expt", handle_pushbuttons, (void *)(RESUME_EXPT), (MenuItem *)NULL },
	{ "Replay Expt", handle_pushbuttons, (void *)(REPLAY_EXPT), (MenuItem *)NULL },
	{ "Reopen Uff", handle_pushbuttons, (void *)(UPLOAD_CODE), (MenuItem *)NULL },
	{ "CheckState", handle_pushbuttons, (void *)(QUERY_STATE), (MenuItem *)NULL },
	{ "Reset Trial Count", handle_pushbuttons, (void *)(RESET_TRIALS), (MenuItem *)NULL },
	{ "End Timeout", handle_pushbuttons, (void *)(END_TIMEOUT), (MenuItem *)NULL },
	{ "Reset", handle_pushbuttons, (void *)(RESET_STATE), (MenuItem *)NULL },
	NULL
};

MenuItem quit_menu[] = {
	{ "Quit", handle_pushbuttons, (char *)QUIT_NOCONFIRM, (MenuItem *)NULL },
	{ "Quit - End Pen", handle_pushbuttons, (char *)QUIT_END_PEN, (MenuItem *)NULL },
	NULL,
};
...
MenuItem fixation_menu[] = {
	{ "Fix X pos (fx)", ParamButtons, (char *)FIXPOS_X, (MenuItem *)NULL },
	{ "Fix Y pos (fy)", ParamButtons, (char *)FIXPOS_Y, (MenuItem *)NULL },
	{ "Fix Window Size (fw)", ParamButtons, (char *)FIXPOS_Y, (MenuItem *)NULL },
	{ "Fix Window Height (fH)", ParamButtons, (char *)FIXPOS_Y, (MenuItem *)NULL },
	{ "Hole around FP (fh)", ParamButtons, (char *)FIXPOS_Y, (MenuItem *)NULL },
	{ "Fixpt Size", ParamButtons, (char *)FIXPOS_Y, (MenuItem *)NULL },
	NULL,
};

MenuItem param_menu[] = {
  { "Fixation", NULL, NULL, fixation_menu },
	{ "RF", handle_pushbuttons, (char *)QUIT_END_PEN, (MenuItem *)NULL },
	NULL,
};
...
MenuItem save_menu[] = {
	{ "Save", set_stimulus, "save", (MenuItem *)NULL },
	{ "Save Stim As", set_stimulus, "Write", (MenuItem *)NULL },
	{ "Save Expt 1", set_stimulus, "Wexp1", (MenuItem *)NULL },
	{ "Save Expt 2", set_stimulus, "Wexp2", (MenuItem *)NULL },
	{ "Save Expt 3", set_stimulus, "Wexp3", (MenuItem *)NULL },
	{ "Save Expt 4", set_stimulus, "Wexp4", (MenuItem *)NULL },
	{ "Save Expt 5", set_stimulus, "Wexp5", (MenuItem *)NULL },
	{ "Save Expt 6", set_stimulus, "Wexp6", (MenuItem *)NULL },
	{ "Save Expt 7", set_stimulus, "Wexp7", (MenuItem *)NULL },
	{ "Save Expt 8", set_stimulus, "Wexp8", (MenuItem *)NULL },
NULL};
#define NEXPSLOTS 8

static MenuItem popup_menu[] = {
  //	{ "Expt", expbuttons, (void *)POPUP_EXPT, (MenuItem *)NULL },
  //	{ "Expts", expbuttons, (void *)POPUP_EXPTS, (MenuItem *)NULL },
#ifdef MICRODRIVE_VERSIONA
	{ "Stepper (Old)", expbuttons, (void *)POPUP_STEPPER, (MenuItem *)NULL },
#else
	{ "Stepper (New)", expbuttons, (void *)POPUP_STEPPER, (MenuItem *)NULL },
#endif
	{ "AFC", expbuttons, (void *)POPUP_AFC, (MenuItem *)NULL },
	{ "BW", expbuttons, (void *)POPUP_BW, (MenuItem *)NULL },
	{ "Wurtz", expbuttons, (void *)POPUP_WURTZ, (MenuItem *)NULL },
	{ "Log", expbuttons, (void *)POPUP_LOG, (MenuItem *)NULL },
//	{ "Unit Log", expbuttons, (void *)POPUP_UNITLOG, (MenuItem *)NULL },
	{ "Options", set_stimulus, "options", (MenuItem *)NULL },
	{ "Panel", set_stimulus, "panel", (MenuItem *)NULL },
	{ "Load StimFile", set_stimulus, "load", (MenuItem *)NULL },
	{ "Save", NULL , (void *)NULL, save_menu },
	{ "Codes", expbuttons, (void *)POPUP_CODES, (MenuItem *)NULL },
	{ "MyCodes", expbuttons, (void *)POPUP_MYCODES, (MenuItem *)NULL },
	{ "Penetration Log", expbuttons, (void *)POPUP_PEN_LOG, (MenuItem *)NULL },
	{ "Cmd History", expbuttons, (void *)(SHOW_COMMAND_HISTORY), (MenuItem *)NULL },
	{ "Help", helpbuttons, (void *)(HELPFILE_PATH), (MenuItem *)NULL },
	{ "Reopen Serial", expbuttons, (void *)RESTART_SERIAL, (MenuItem *)NULL },
	//	{ "Graphs", expbuttons, (void *)POPUP_GRAPHS, (MenuItem *)NULL },
	/*	{ "Cyber", expbuttons, (void *)POPUP_CYBER, (MenuItem *)NULL },*/
	{ "Quit", NULL , (void *)NULL, quit_menu },
	NULL};

static MenuItem ppopup_menu[] = {
  //	{ "Expt", expbuttons, (void *)POPUP_EXPT, (MenuItem *)NULL },
  //	{ "Expts", expbuttons, (void *)POPUP_EXPTS, (MenuItem *)NULL },
	{ "Stepper", expbuttons, (void *)POPUP_STEPPER, (MenuItem *)NULL },
	{ "AFC", expbuttons, (void *)POPUP_AFC, (MenuItem *)NULL },
	{ "BW", expbuttons, (void *)POPUP_BW, (MenuItem *)NULL },
	{ "Wurtz", expbuttons, (void *)POPUP_WURTZ, (MenuItem *)NULL },
	{ "Log", expbuttons, (void *)POPUP_LOG, (MenuItem *)NULL },
//	{ "Unit Log", expbuttons, (void *)POPUP_UNITLOG, (MenuItem *)NULL },
	...
	{ "Codes", expbuttons, (void *)POPUP_CODES, (MenuItem *)NULL },
	{ "Penetration Log", expbuttons, (void *)POPUP_PEN_LOG, (MenuItem *)NULL },
	{ "Help", expbuttons, (void *)(HELPFILE_PATH), (MenuItem *)NULL },
	{ "Graphs", expbuttons, (void *)POPUP_GRAPHS, (MenuItem *)NULL },
	/*	{ "Cyber", expbuttons, (void *)POPUP_CYBER, (MenuItem *)NULL },*/
	{ "Quit", NULL , (void *)NULL, pquit_menu },
	NULL};
...
static MenuItem *quick_menu = NULL;
static MenuItem *quick_submenu[MAXQUICK_SUB] = {NULL};

static MenuItem *help_submenu = NULL;

/*
{
	{ "NEXT", expbuttons, (void *)NEXT_EXPT, (MenuItem *)NULL },
	{ "expt1", expbuttons, (void *)EXPT_LOAD1, (MenuItem *)NULL },
	{ "expt2", expbuttons, (void *)EXPT_LOAD2, (MenuItem *)NULL },
	{ "expt3", expbuttons, (void *)EXPT_LOAD3, (MenuItem *)NULL },
	{ "expt4", expbuttons, (void *)EXPT_LOAD4, (MenuItem *)NULL },
	{ "expt5", expbuttons, (void *)EXPT_LOAD5, (MenuItem *)NULL },
	NULL
};
*/
...
static Sliderdat exptsliderprops[] =
{
  {0.0, 1000.0, 0, TRIGGER_LEVEL, NULL },
  {0.0, 1000.0, 0, TRIGGER_LEVEL1, NULL },
  {0.0, 1000.0, 0, TRIGGER_LEVEL2, NULL },
  {0.0, 1000.0, 0, TRIGGER_LEVEL3, NULL },
  {0.0, 1000.0, 0, TRIGGER_LEVEL4, NULL },
  {0.0, 2.0, 2, FIXATION_WINDOW, NULL },
  {0.0, 1.0, 2, ISI_CODE, NULL },
  {0.0, 1.0, 2, PREPERIOD_CODE, NULL },
  {0.0, 1.0, 2, POSTPERIOD_CODE, NULL },
  {0.0, 2.0, 2, CLAMP_DISPARITY_CODE, NULL },
  {0.0, 2.0, 2, FIXATION_OVERLAP, NULL },
  {0.0, 10.0, 2, ELECTRODE_DEPTH, NULL },
  {0.0, 2.0, 2, PREWARD, NULL },
  {0.0, 10.0, 0, PLOTSMOOTH, NULL },
  {0.0, 10.0, 0, RC_DELAY, NULL },
  { 0.0, 500, 0, REWARD_SIZE, NULL },
  { 0.0, 1.0, 2, TARGET_RATIO, NULL },
  NULLPROP,
};
...
static Sliderdat exptsliderprops[] =
{
  {0.0, 1000.0, 0, TRIGGER_LEVEL, "Trigger (mV)"},
  {0.0, 1000.0, 0, TRIGGER_LEVEL1, "Trigger 1(mV)"},
  {0.0, 1000.0, 0, TRIGGER_LEVEL2, "Trigger 2(mV)"},
  {0.0, 1000.0, 0, TRIGGER_LEVEL3, "Trigger 3(mV)"}, 
  {0.0, 1000.0, 0, TRIGGER_LEVEL4, "Trigger 4(mV)"},
  {0.0, 2.0, 2, FIXATION_WINDOW, "Fixation Window"},
  {0.0, 1.0, 2, ISI_CODE, "ISI"},
  {0.0, 1.0, 2, PREPERIOD_CODE, "PrePeriod"},
  {0.0, 1.0, 2, POSTPERIOD_CODE, "PostPeriod"},
  {0.0, 2.0, 2, CLAMP_DISPARITY_CODE, "Disp. Clamp"},
  {0.0, 2.0, 2, FIXATION_OVERLAP, "Fix overlap"},
  {0.0, 10.0, 2, ELECTRODE_DEPTH, "Electrode Depth"},
  {0.0, 2.0, 2, PREWARD, "P(Reward)"},
  {0.0, 10.0, 0, PLOTSMOOTH, "Smooth PSTH"},
  {0.0, 10.0, 0, RC_DELAY, "RC delay"},
  { 0.0, 500, 0, REWARD_SIZE, "Reward Size"},
  { 0.0, 1.0, 2, TARGET_RATIO, "Target Ratio"},
  NULLPROP,
};
*/
...
static Sliderdat sliderprops[] =
{
	...
	{0.0, 1.0, 2, POSTPERIOD_CODE, "PostPeriod"},
	{0.0, 2.0, 2, CLAMP_DISPARITY_CODE, "Disp. Clamp"},
	{0.0, 10.0, 2, RAMP_AMPLITUDE_CODE, "Ramp Size"},
	{0.0, 10.0, 2, RAMP_COEFFICIENT, "Ramp Coefficient"},
	NULLPROP,
};



Widget exframe = 0,stimlist = 0, allframe = 0, astimlist = 0, allclock = 0, allstatuswidget = 0, astim2list = 0, gstimlist = 0;
Widget watchwidget = 0;
static Widget runbutton, tpanel,tttw,arunbutton,penpanel,helppanel;
...
static Fpslider *meanslider,*incrslider;
...
void ParamButtons(Widget w, XtPointer data, 
XmPushButtonCallbackStruct *cbs)
{
	...
	XmString str;
	int what;
	static int oldoption, oldboption;
...
void RunWaterAlarm()
{
  ...
  SerialString(mbuf,0);
  i = confirm_yes("!!      ???????             Did you record the water ?????????        !!",NULL);
  if(i && penlog){
...
void write_windowpos(FILE *ofd)
{
  Position x,y;
  if(stepform){
    XtVaGetValues(stepform,XmNx,&x,NULL);
    XtVaGetValues(stepform,XmNy,&y,NULL);
    fprintf(ofd,"stepperxy=%d %d\n",x,y);
  }
  else{
    fprintf(ofd,"stepperxy=%d %d\n",winposns[STEPPER_WIN].x,winposns[STEPPER_WIN].y);
  }
  if(penpanel){
    XtVaGetValues(penpanel,XmNx,&x,NULL);
    XtVaGetValues(penpanel,XmNy,&y,NULL);
    fprintf(ofd,"penwinxy=%d %d\n",x,y);
  }
  else{
    fprintf(ofd,"penwinxy=%d %d\n",winposns[PENLOG_WIN].x,winposns[PENLOG_WIN].y);
  }
  if(bwframe){
    XtVaGetValues(bwframe,XmNx,&x,NULL);
    XtVaGetValues(bwframe,XmNy,&y,NULL);
    fprintf(ofd,"bwwinxy=%d %d\n",x,y);
  }
  else{
    fprintf(ofd,"bwwinxy=%d %d\n",winposns[BW_WIN].x,winposns[BW_WIN].y);
  }
  if(oform){
    XtVaGetValues(oform,XmNx,&x,NULL);
    XtVaGetValues(oform,XmNy,&y,NULL);
    fprintf(ofd,"optionwinxy=%d %d\n",x,y);
  }
  else{
    fprintf(ofd,"optionwinxy=%d %d\n",winposns[OPTIONS_WIN].x,winposns[OPTIONS_WIN].y);
  }
  if(aframe){
    XtVaGetValues(aframe,XmNx,&x,NULL);
    XtVaGetValues(aframe,XmNy,&y,NULL);
    fprintf(ofd,"afcwinxy=%d %d\n",x,y);
  }
  else{
    fprintf(ofd,"afcwinxy=%d %d\n",winposns[AFC_WIN].x,winposns[AFC_WIN].y);
  }
  if(psychfilename)
	  fprintf(ofd,"psychfile=%s\n",psychfilename);
  if(expt.cmdinfile)
	  fprintf(ofd,"cmdfile=%s\n",expt.cmdinfile);
}
...
void write_sliders(FILE *ofd)
{
  ...
  Fpslider *fp;
    ...
    if((fp = allfps[NALLSLIDERS-1]) == NULL)
      return;
    while(fp->next != NULL){
      fp = fp->next;
      fprintf(ofd,"popup=%2s\n",serial_strings[fp->code]);
    }
    for(i = 0; i < NALLSLIDERS; i++)
      fprintf(ofd,"slider%d=%2s\n",i,serial_strings[allfps[i]->code]);
    fprintf(ofd,"eslider=%2s\n",serial_strings[expslider->code]);
}
...
void handle_expbuttons(Widget w, XtPointer data, 
XmPushButtonCallbackStruct *cbs)
{
	...
	switch ((int)data)
	  ...
	  case DONEBUTTON:
	    text_set_expvals();
	  case CANCELBUTTON:
	    CloseShell(tpanel,XtParent(tpanel));
	    break;
          case APPLYBUTTON:
	    text_set_expvals();
	    SetTargets();
...
void handle_penbuttons(Widget w, XtPointer data, 
XmPushButtonCallbackStruct *cbs)
{
	...
	switch ((int)data)
	  {
	  case DONEBUTTON:
	    expt.newpen = numeric_get_value(penidw);
	    OpenPenetrationLog(expt.newpen);
	  case CANCELBUTTON:
	    CloseShell(penpanel,XtParent(penpanel));
	    break;
          case RELOADDEPTHBUTTON:
	    ReadPenSteps(expt.penfile);
	    optionflags[PLOT_ELECTRODE_TRACK] = 1;
	    break;
          case APPLYBUTTON:
	    expt.newpen = numeric_get_value(penidw);
	    s = numeric_get_string(xpenid);
	    sscanf(s,"%f",&expt.vals[PENXPOS]);
	    s = numeric_get_string(ypenid);
	    sscanf(s,"%f",&expt.vals[PENYPOS]);
	    OpenPenetrationLog(expt.newpen);
	    PrintPenLog(0);
	    break;
          case REFRESHBUTTON:
...
void graphlist_popup(Widget parent)
{
  ...
  if(gpanel == NULL)
    {
      n = 0;
      gpanel = XmCreateFormDialog(parent,"DataEdit",args,n);
      item = my_make_button(gpanel,"Done", CloseShell,
	    NULL, 0, (int)XtParent(gpanel));
      gstimlist = XmCreateScrolledList(gpanel, "graphlist", NULL, 0);
    XtVaSetValues(XtParent(gstimlist),
		  XmNtopAttachment, XmATTACH_WIDGET,
		   XmNtopWidget, item,
		  NULL);
    XtVaSetValues(gstimlist, XmNitemCount, 0,
		  XmNselectionPolicy, XmSINGLE_SELECT, 
		   NULL);
    XtAddCallback(gstimlist, XmNsingleSelectionCallback, (XtCallbackProc)graphlist_proc, (XtPointer)gstimlist);
    ListGraphs(gstimlist);
    XtManageChild(gstimlist);
      item = my_make_button(gpanel,"List", expbuttons, item,
			    NEXTRIGHTWIDGET_BIT, POPUP_GRAPHS);
    XtManageChild(gpanel);
    }
    ListGraphs(gstimlist);
  fiterate(gpanel,0,0);
  XtPopup(XtParent(gpanel),XtGrabNone);
}
...
void PrintPenLog(int scroll)
{
  ...
  XmTextSetString(tttw,s);
  if(scroll){
    XmTextShowPosition(tttw,strlen(s));
  }
}
...
{
	int i,x,y,n;
	char s[BUFSIZ*3],tmp[256];
	Arg args[20];
	Widget rc,litem,item,w;
	...
	if(penpanel == NULL)
	  {
	    ...
	    penpanel = XmCreateFormDialog(parent,"DataEdit",args,n);

	rc = XtVaCreateWidget("rc", xmFormWidgetClass, penpanel,
		XmNleftAttachment, XmATTACH_FORM,
		XmNrightAttachment, XmATTACH_FORM,
		XmNtopAttachment, XmATTACH_FORM, 
			      0);
	XtVaGetValues(rc, XmNrowColumnType, &i, 0);

	litem = item = my_make_button(rc,"Done",handle_penbuttons,0,0,DONEBUTTON);
	item = my_make_button(rc,"Apply",handle_penbuttons,item,NEXTRIGHTWIDGET_BIT,APPLYBUTTON);
	item = my_make_button(rc,"Cancel",handle_penbuttons,item,NEXTRIGHTWIDGET_BIT,CANCELBUTTON);
       	item = my_make_menu_button(rc,"Do", NULL, penlog_menu,item, NEXTRIGHTWIDGET_BIT);
	item = my_make_cycle(rc,"Cell",cycle_proc,item,NEXTRIGHTWIDGET_BIT,VWHERE,vstrings,NULL);
	penidw = litem = item = my_make_numeric(rc,"Pen #",numeric_proc,litem,NEXTDOWNWIDGET_BIT,expt.ipen,3,PENNUMCOUNTER);
	xpenid = item = my_make_numeric(rc,"X",numeric_proc,item,NEXTRIGHTWIDGET_BIT,
			        (int)(expt.vals[PENXPOS]),2,PENXPOS);
	xpenv = numeric_set(item, PANEL_MIN_VALUE, -20, NULL);
	ypenid = item = my_make_numeric(rc,"Y",numeric_proc,item,NEXTRIGHTWIDGET_BIT,
			       (int)(expt.vals[PENYPOS]),2,PENYPOS);
	numeric_set(item, PANEL_MIN_VALUE, -20,NULL);
	litem = item = my_make_text(rc,"Impedance","",bw_text_proc,litem,NEXTDOWNWIDGET_BIT,4,IMPEDANCE);
	protitem = item = my_make_text(rc,"Protrudes (mm)","",bw_text_proc,item,NEXTRIGHTWIDGET_BIT,4,PROTRUSION);
	item = my_make_cycle(rc,"User",cycle_proc,item,NEXTRIGHTWIDGET_BIT,USERNAME,userstrings,NULL);
	set_option_value(item, userid);
	item =  XtVaCreateWidget("togglebox",
				 xmRowColumnWidgetClass, rc,
				 XmNtopAttachment, XmATTACH_WIDGET,
				 XmNtopWidget, litem,
	    NULL);
	w = XtVaCreateManagedWidget("Adapter",
		  xmToggleButtonGadgetClass,item, 
		    XmNset, FALSE,NULL);
	XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)stimtoggle_callback, (XtPointer)ADAPTER_TOGGLE);
	w = XtVaCreateManagedWidget("R hemisphere",
		  xmToggleButtonGadgetClass,item, 
		    XmNset, expt.hemisphere,NULL);
	XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)stimtoggle_callback, (XtPointer)RHEMISPHERE_TOGGLE);
	XtManageChild(item);
	item = my_make_cycle(rc,"Trode",cycle_proc,item,NEXTRIGHTWIDGET_BIT,ELECTRODE_TYPE,electrodestrings,NULL);
	set_option_value(item, userid);
	XtManageChild(rc);
	...
	tttw = XmCreateScrolledText(penpanel, "data_text", args, n);
	XtManageChild(tttw);
	XtManageChild(penpanel);
      }
	else
	  XtPopup(XtParent(penpanel),XtGrabNone);
	PrintPenLog(0);
	SetPenPanel();
	fiterate(penpanel, 0 ,0);
}

void help_popup(Widget parent, char *file)
{
  int i,x,y,n;
  char s[BUFSIZ*100],tmp[BUFSIZ];
  Arg args[20];
  Widget rc,litem,item;
  Widget txtw,helppanel;
  FILE *fd;
  
      n = 0;
      helppanel = XmCreateFormDialog(parent,"HelpWin",args,n);
      rc = XtVaCreateWidget("rc", xmFormWidgetClass, helppanel,
		XmNleftAttachment, XmATTACH_FORM,
		XmNrightAttachment, XmATTACH_FORM,
		XmNtopAttachment, XmATTACH_FORM, 
			      0);
      ...
      item = my_make_button(rc,"Done", FDestroyShell,
	    NULL, 0, (int)XtParent(helppanel));
      XtManageChild(rc);

      n = 0;
      XtSetArg(args[n],XmNuserData, 10001); n++;
      XtSetArg(args[n],XmNleftAttachment, XmATTACH_FORM); n++;
      XtSetArg(args[n],XmNrightAttachment, XmATTACH_FORM); n++;
      XtSetArg(args[n],XmNtopAttachment, XmATTACH_WIDGET); n++;
      XtSetArg(args[n],XmNtopWidget, rc); n++;
      XtSetArg(args[n],XmNeditMode, XmMULTI_LINE_EDIT); n++;
      txtw = XmCreateScrolledText(helppanel, "help_text", args, n);
      XtManageChild(txtw);
      XtManageChild(helppanel);
  
  if(txtw && (fd = fopen(file,"r")) != NULL){
    sprintf(s,"%s:\n",file);
    while(fgets(tmp,BUFSIZ,fd)){
      strcat(s,tmp);
    }
    XmTextSetString(txtw,s);
    fclose(fd);
  }
  else if(fd == NULL)
    fprintf(stderr,"Cannot open helpfile %s\n",file);
  fiterate(helppanel, 0 ,0);
}
...
void cmd_popup(Widget parent, char *file)
{
  ...
  if(txtw && (fd = fopen(file,"r")) != NULL){
    sprintf(s,"%s:\n",file);
    while(fgets(tmp,BUFSIZ,fd)){
      if(strncmp(tmp,"Reopened",6) == NULL)
	sprintf(s,"%s",tmp);
      else
	strcat(s,tmp);
    }
...
void expval_popup(Widget parent, int mode)
{
	...
	if(tpanel == NULL)
	  {
	    n = 0;
	    tpanel = XmCreateFormDialog(parent,"DataEdit",args,n);

	rc = XtVaCreateWidget("rc", xmFormWidgetClass, tpanel,
		XmNleftAttachment, XmATTACH_FORM,
		XmNrightAttachment, XmATTACH_FORM,
		XmNtopAttachment, XmATTACH_FORM, 
			      0);
	...
	litem = item = my_make_button(rc,"Done",handle_expbuttons,0,0,DONEBUTTON);
	item = my_make_button(rc,"Apply",handle_expbuttons,item,NEXTRIGHTWIDGET_BIT,APPLYBUTTON);
	item = my_make_button(rc,"Cancel",handle_expbuttons,item,NEXTRIGHTWIDGET_BIT,CANCELBUTTON);
	XtManageChild(rc);
	...
	XtSetArg(args[n],XmNtopWidget, rc); n++;
	XtSetArg(args[n],XmNeditMode, XmMULTI_LINE_EDIT); n++;
	tttw = XmCreateScrolledText(tpanel, "data_text", args, n);
	XtManageChild(tttw);
	XtManageChild(tpanel);
      }
	else
	  XtPopup(XtParent(tpanel),XtGrabNone);
	...
	switch(popmode)
	  ...
	  case EDIT_EXP2VALS:
	    sprintf(s,"");
	    for(i = expt.nstim[0]+expt.nstim[2]; i < expt.nstim[0] + expt.nstim[1] + expt.nstim[2]; i++)
	      {
		sprintf(tmp,"%.3f\n",expval[i]);
		strcat(s,tmp);
	      }
...
void SetAllItem(Expt *ex, Widget w)
{
	...
	{
	case LOGFILE_CODE:
	  settextvalue(w, expt.logfile);
	  break;
	case UFF_PREFIX:
	  SetBWItem(expt.bwptr, w);
	    break;
	case EXPTYPE:
	  set_option_value(w, ex->mode);
	  break;
	case EXPTYPE3:
	    set_option_value(w, ex->type3);
	    break;
	case EXPTYPE2:
	  if(ex->type2 == MONOCULARITY_EXPT){
	    if(ex->incr2 == 2 && ex->mean2 == 0)
	      set_option_value(w, LRINTERLEAVE);
	    else if(ex->incr2 == 1 && ex->mean2 == 0)
	      set_option_value(w, LRBINTERLEAVE);
	    else if(ex->incr2 == 1 && ex->mean2 == 0.5)
	      set_option_value(w, RBINTERLEAVE);
	    else if(ex->incr2 == 1 && ex->mean2 == -0.5)
	      set_option_value(w, LBINTERLEAVE);
	  }
	  else if(ex->type2 == BACKSTIM_TYPE){
	    if(ex->incr2 == 2 && ex->mean2 == 1)
	      set_option_value(w, RDSBNONE);
	  }
	  else if(ex->type2 == TF){
	      set_option_value(w, TFLIN);
	  }
	  else
	    set_option_value(w, ex->type2);
		break;
	      case EXPT_MEAN:
		atofitem(w, expt.mean,nfplaces[expt.mode]);
		break;
	      case EXPT2_MEAN:
		atofitem(w, expt.mean2,nfplaces[expt.type2]);
		break;
	      case EXPT_INCR:
		if(optionflags[REVERSE_CORRELATE]){
		  val = (expt.incr * expt.st->nframes)/expt.st->framerepeat;
		  atofitem(w, val,nfplaces[expt.mode]);
		  settextlabel(w,"range");		}
		else{
		  atofitem(w, expt.incr,nfplaces[expt.mode]);
		  settextlabel(w,"incr");
		}
		break;
	      case EXPT2_INCR:
		atofitem(w, expt.incr2,nfplaces[expt.type2]);
		break;
	      case NTRIALS_CODE:
		numeric_set_value(w,expt.nstim[0]);
		break;
	case XY_FSD:
	  SetFSD(w,XY_FSD);
	  break;
	case EYE_DOMINANCE:
		set_option_value(w, dominanteye);
	  break;
	      case EXPT2_NSTIM:
		numeric_set_value(w,expt.nstim[1]);
		break;
	      case PLOT_CLUSTER:
		numeric_set_value(w,expt.plotcluster);
		break;
	      case TRIGGER_LEVEL:
		numeric_set_value(w,(int)expt.tl);
		break;
	      case NREPS_CODE:
		numeric_set_value(w, ex->nreps);
		break;
	      case EXPT_STIMPERTRIAL:
		numeric_set_value(w, ex->stimpertrial);
		break;
	      case EXPT_BLKSIZ:
		numeric_set_value(w, ex->blksize);
		break;
	      case ADDEXPTS_CODE:
		XtVaGetValues(w, XmNnumChildren, &n, XmNchildren, &l, 0);
		for(j = 0; j < n; j++)
		  {
		    if(j == 1 && expt.flag & TIMES_EXPT2)
		      XtVaSetValues(l[j],  XmNset, TRUE,NULL);
		    else if(j == 0 && expt.flag & ADD_EXPT2)
		      XtVaSetValues(l[j], XmNset, TRUE,NULL);
		    else 
		      XtVaSetValues(l[j], XmNset, FALSE,NULL);
		  }
		break;
	      case OPTION_CODE:
		XtVaGetValues(w, XmNnumChildren, &n, XmNchildren, &l, 0);
		if(expt.vals[ACQUISITION_CODE] > 0.5)
		  XtVaSetValues(l[0],  XmNset, TRUE,NULL);
		else
		  XtVaSetValues(l[0], XmNset, FALSE,NULL);
		j = 1;
		for(i = 0; i < 32; i++)
		  if(alloptions & (1<<i) && j < n)
		  {
		    XtVaSetValues(l[j],
		...
		for(i = 0; i < 32; i++)
		  if(all2options & (1<<i) && j < n)
		  {
		    XtVaSetValues(l[j],
		    XmNset, (option2flag & (1<<i)) ? TRUE : FALSE,NULL);
		    j++;
		  }
		i = MAXOPTIONBITS;
		while(j < n && i < MAXOPTIONBITS + MAXALLFLAGS)
		  {
		    if(allflags[i-MAXOPTIONBITS] && j < n)
		      {
			XtVaSetValues(l[j],
			XmNset, (optionflags[i-MAXOPTIONBITS]) ? TRUE : FALSE,NULL);
			j++;
		      }
		    i++;
		  }
		i = 0;
		while(j < n && i < NUM_STIM_FLAGS)
		  {
		    if(allstimflags & (1<<i) && j < n)
		      {
			XtVaSetValues(l[j],
			XmNset, stimptr->flag & (1<<i) ? TRUE : FALSE,NULL);
			j++;
		      }
		    i++;
		  }
		break;
	case WHICHSTIM:
	  if(stimptr->splane == STIM_CHOICE1_BIT)
	    set_option_value(w, STIM_CHOICE1);
	  else if(stimptr->splane == STIM_CHOICE2_BIT)
	    set_option_value(w, STIM_CHOICE2);
	  else if(stimptr->splane == STIM_THIRD_BIT)
	    set_option_value(w, STIM_NUM3);
	  else if(stimptr->prev != NULL)
	    set_option_value(w, STIM_BACKGROUND);
	  else
	    set_option_value(w, STIM_FOREGROUND);
	  break;
	case STIMTYPE:
	  set_option_value(w, stimptr->type);
	  break;
      }
	SetCyberPanel(NULL);
}
...
void SetAllSliders()
{
  ...
  for(j = 0; j < NALLSLIDERS; j++)
    {
      if(allfps[j] != NULL)
	for(i = 0; i < allfps[j]->nprops; i++)
	  set_fpslider(allfps[j], allfps[j]->proplist[i].code, GetProperty(&expt,stimptr,allfps[j]->proplist[i].code));
    }
  for(i = 0; i < expslider->nprops; i++)
    set_fpslider(expslider, expslider->proplist[i].code, GetProperty(&expt,stimptr,expslider->proplist[i].code));
...
void SetPenPanel()
{
  ...
  if(penpanel == NULL)
	return;
	XtVaGetValues(penpanel, XmNnumChildren, &n, XmNchildren, &l, 0);
	w = l[0];
	XtVaGetValues(w, XmNnumChildren, &n, XmNchildren, &l, 0);
	...
	for(i = 0; i < n; i++){
	  ...
	  switch(what){
	  case PENNUMCOUNTER:
	    numeric_set_value(l[i],expt.ipen);
	    break;
	  case PENXPOS:
	  case PENYPOS:
	    sprintf(buf,"%.1f",expt.vals[what]);
	    numeric_set_string(l[i],buf);
	    break;
	  case VWHERE:
	    str = XmStringCreateSimple(expname);
	    XtVaSetValues(l[i],XmNlabelString,str,0);
	    //	    XtVaSetValues(l[i],XmNstring,expname,0);
	    set_option_value(l[i], (int)(expt.vals[VWHERE]));
	    break;
	case USERNAME:
	  set_option_value(l[i], userid);
	  break;
	  }
	}
}

MakeTextLabel(int i, char *buf)
{
  int j,np;
  float val;
 char tmp[BUFSIZ];
  ...
  switch(i){
  case HIDDEN_OPTIONS:
    i = LAST_CODED_OPTION+1;
    sprintf(buf,"Hid:%d",optionflags[i]);
    while(i< MAXALLFLAGS){
      sprintf(tmp,"%d",optionflags[i++]);
      strcat(buf,tmp);
    }
    break;
  ...
  case NLOWCOMPONENTS:
  case NCOMPONENTS:
	sprintf(buf,"%s=%.3f,%.3f->%.3f",serial_names[i],GetProperty(&expt,stimptr,i),expt.st->freqs[0],expt.st->freqs[expt.st->nfreqs-1]);
	break;
  case DOT_DENSITY:
  case DOT_SIZE:
	sprintf(buf,"%s=%.*f,%d dots",serial_names[i],nfplaces[i],GetProperty(&expt,stimptr,i),expt.st->left->ndots);
    break;
  case ORTHOG_DISP:
  case PARALELL_DISP:
	sprintf(buf,"%s=%.3f,%2s=%.2f,%2s=%.2f",serial_names[i],GetProperty(&expt,stimptr,i),serial_strings[DISP_X],GetProperty(&expt,stimptr,DISP_X),serial_strings[DISP_Y],GetProperty(&expt,stimptr,DISP_Y));
	break;
      case OPTION_CODE:
	MakeString(i, buf, &expt, expt.st,TO_FILE);
	break;
      case GRIDSIZE:
	sprintf(buf,"%s=%.3f,%.1f pix",serial_names[i],expt.vals[GRIDSIZE],deg2pix(expt.vals[GRIDSIZE]));
	break;
      case VERSION_CODE:
      case SOFTOFF_CODE:
      case UKA_VALS:
      case USERID:
	MakeString(i, buf, &expt, expt.st,0);
	break;
      case DISP_P:
	sprintf(buf,"%s=%.3f",serial_names[i],180/M_PI * GetProperty(&expt,stimptr,i));
	break;
  case TRAPEZOIDAL_SCALING:
	sprintf(buf,"%s=%.7f %.7f %.7f %.7f",serial_names[i],expt.mon->trapscale[0],expt.mon->trapscale[2],expt.mon->trapscale[4],expt.mon->trapscale[6]);
	break;
  case GAMMAVAL_CODE:
    sprintf(buf,"%s=%.*f %.4f",serial_names[i],nfplaces[i],expt.mon->gamma,expt.mon->truegamma);
    break;
  case HSACCADE_VALUE:
  case VSACCADE_VALUE:
    j = (i == HSACCADE_VALUE) ? 0 : 1;
    sprintf(buf,"%s=%.2f(%.2f)",serial_names[i],afc_s.abssac[j],afc_s.sacval[j]);
    break;
  case STIM_HEIGHT:
	sprintf(buf,"%s=%.3f,%.1f pixels",serial_names[i],GetProperty(&expt,stimptr,i),expt.st->pos.imsize[0]);
	break;
  case EXPT3_NSTIM:
    sprintf(buf,"N3 %d %.1f",expt.nstim[4],expt.exp3vals[0]);
    for(i = 1; i < expt.nstim[4]; i++){
      sprintf(tmp,",%.1f",expt.exp3vals[i]);
      strcat(buf,tmp);
    }
    break;
  case STIMULUS_MODE:
    sprintf(buf,"%d:%s",expt.stimmode,mode_names[expt.stimmode]);
    break;
      default:
	val = GetProperty(&expt,stimptr,i);
	if(fabs(val) < 0.0001 && fabs(val) > 0 && nfplaces[i] < 6)
	  np = 6;
	if(fabs(val) < 0.01 && fabs(val) > 0 && nfplaces[i] < 4)
	  np = 4;
	else
	  np = nfplaces[i];

	sprintf(buf,"%s=%.*f",serial_names[i],np,val);
	break;
      }
}
...
SetWatches(Widget w)
{
  ...
  for(i = 0 ; i < MAXTOTALCODES; i++)
    {
      if(watchcodes[i] ==1 || 
	 (watchcodes[i] == SEND_NON_ZERO && (val = GetProperty(&expt,expt.st,i)) != 0)){
	sprintf(tmp,"%2s=",serial_strings[i]);
	   strcat(buf,tmp);
	   MakeTextLabel(i,tmp);
	   strcat(buf,tmp);
      }
...
void SetAllPanel(Expt *ex)
{
	...
	if(allframe == NULL)
		return;
	SetAllSliders();
	XtVaGetValues(allframe, XmNnumChildren, &n, XmNchildren, &l, 0);
	for(i = 0; i < n; i++)
		SetAllItem(ex, l[i]);
	ListExpStims(NULL);
	update_option_display();
	SetPenPanel();
	ShowTextVal(textcode,NULL);
	SetWatches(watchwidget);
}
...
void allfproc(Fpslider *fp, float val, XEvent *event)
{
  ...
  switch(fp->code)
    ...
    case PREPERIOD_CODE:
    case TARGET_RATIO:
      expfproc(fp, val, event);
      break;
    case VSACCADE_VALUE:
    case HSACCADE_VALUE:
      afcfproc(fp, val, event);
	    break;
...
void acq_callback(Widget item, int bit, XmToggleButtonCallbackStruct *cbs)
{
  ...
  if(bit == ACQUISITION_CODE){
    expt.vals[ACQUISITION_CODE] = cbs->set ? 1.0 : 0.0; 
  if(!cbs->set){
    StopGo(STOP);
    SetAllPanel(&expt);
  }
  sprintf(buf,"%s%c\n",serial_strings[ACQUISITION_CODE],cbs->set ? '+' : '-');
  SerialString(buf,0);
  }
  else if(bit == 1){
    if(cbs->set){
...
void MakeMainToggle(){
  ...
  if(maintoggle_box != NULL)
    XtUnmanageChild(maintoggle_box);
  maintoggle_box = XtVaCreateWidget("togglebox",
				   xmRowColumnWidgetClass, allframe,
	    XmNtopAttachment, XmATTACH_WIDGET,
	    XmNtopWidget, nrepsw,
	    XmNuserData, OPTION_CODE,
	    NULL);

	w = XtVaCreateManagedWidget("Acq:",
		  xmToggleButtonGadgetClass, maintoggle_box, 
		    XmNset, FALSE,NULL);
	XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)acq_callback, (XtPointer)(ACQUISITION_CODE));

  i = 0;
	while(toggle_strings[i] != NULL)
	  {
	    if(( i < 32 && alloptions & (1<<i)) || ( i >= 32 &&(all2options & (1<<(i-32))) && i < 64) || (i >= MAXOPTIONBITS && allflags[i-MAXOPTIONBITS]))
	      {
 	...
 	i=0;
 	while(flagstrings[i] != NULL){
 	    if(allstimflags & (1<<i)){
 		w = XtVaCreateManagedWidget(flagstrings[i],
 		    xmToggleButtonGadgetClass, maintoggle_box,
 		    XmNset, (expt.st->flag & (1<<i)) ? TRUE : FALSE,NULL);
 		XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)stimtoggle_callback, (XtPointer)i);
 	    }
 		i++;
 	}
	fiterate(maintoggle_box, 0, 0);
	XtManageChild(maintoggle_box);
	if(sliderbox){
	XtVaSetValues(sliderbox, XmNtopWidget, maintoggle_box, NULL);
	/*  XtManageChild(sliderbox);
	    XtManageChild(allframe);*/
	}
	windowlist[2] = XtWindow(maintoggle_box);
}
...
Widget make_helpmenu(MenuItem *pmenu)
{
  ...
  while(pmenu[j].label != NULL){
    if(pmenu[j].callback_data == (void *)(HELPFILE_PATH)){
      helpid = j;
    }
    j++;
  }
  ...
  if(help_submenu == NULL){
    help_submenu = (MenuItem *)malloc(sizeof(MenuItem) * (MAXHELPFILES));
    for(j = 0; j < MAXHELPFILES; j++)
      help_submenu[j].label = NULL;
  }
  for(j = 0; j < nhelpfiles; j++){
    help_submenu[j].subitems = NULL;
    help_submenu[j].label =  myscopy(help_submenu[j].label,helplabels[j]);
    help_submenu[j].callback = helpbuttons;
    help_submenu[j].callback_data = (void *)(j);
  }
  help_submenu[j].label =  NULL;
  pmenu[helpid].subitems = help_submenu;
}

Widget make_quickmenu()
{
  int i,n,foreground,j,smmode = 0;
  char stimname[BUFSIZ], buf[BUFSIZ],expaname[BUFSIZ],expbname[BUFSIZ],*s;
  char typename[BUFSIZ];
  FILE *fd;

/*
 * This is called each time one of the online Qexps is
 * changed (to update the label). So it needs to check all of these.
*/

 
/*
 * Try to put all of the online saved expts into a submenu called "Today"
 * then the labels can be longer, and there can be more expts.
 */
  j = nsubmenus;
  /*  if(quick_submenu[nsubmenus])
    free(quick_submenu[nsubmenus]);
  quick_submenu[nsubmenus] = (MenuItem *)malloc(sizeof(MenuItem) * (100));
  */
  memset(quick_submenu[j], 0, (sizeof(MenuItem) * (100)));
  quick_submenu[j][0].callback = expbuttons;
  quick_submenu[j][0].label = myscopy(quick_submenu[j][0].label,"Today");
  quick_submenu[j][0].callback_data = (void *)(EXPT_LOAD1+nquickexpts-1);


  j = -1;
  for(i = 0; i < NEXPSLOTS; i++){
    smmode = 0;
    sprintf(buf,"./q%dexp",i+1);
    sprintf(typename,"");
    if((fd = fopen(buf,"r"))){
      j++;  // == i, IF qn file exists
	  sprintf(expaname,"??");
	  sprintf(expbname,"??");
	  sprintf(stimname,"??");
      foreground = 1;
      while ((fgets(buf, BUFSIZ, fd)) != NULL){
	if(!strncmp(buf,"mo=back",7)){
	  foreground = 0;
	}
	else if(!strncmp(buf,"mo=fore",7)){
	  foreground = 1;
	}
	else if(!strncmp(buf,"mo=Ch",5)){ // Choice stims
	  foreground = 0;
	}
	if(foreground){
	  if(!strncmp(buf,"st=grat",7)){
	    sprintf(stimname,"sine");
	  }
	  else if(!strncmp(buf,"st=",3)){
	    sprintf(stimname,"%s",&buf[3]);
	  }
	  else if(!strncmp(buf,"et=",3)){
	    sprintf(expaname,"%s",&buf[3]);
	  }
	  else if(!strncmp(buf,"e2=",3)){
	    sprintf(expbname,"%s",&buf[3]);
	  }
	  else if(!strncmp(buf,"sM=",3)){
	    sscanf(buf,"sM=%d",&smmode);
	  }
	  if(!strncmp(buf,"op=",3)){
	    if(strstr(buf,"+rS")){
	      sprintf(typename,"RC");
      ...
      fclose(fd);
      if((s = strchr(expaname,'#')) != NULL)
	*s = 0;
      if((s = strchr(expbname,'#')) != NULL)
	*s = 0;
      if((s = strchr(stimname,'#')) != NULL)
	*s = 0;
      if(smmode)
	sprintf(buf,"Q%s%s%s%s sM=%d",stimname,expaname,expbname,typename,smmode);
      else
	sprintf(buf,"Q%s%s%s%s",stimname,expaname,expbname,typename);
      n = nquickexpts+j-nallsubs+nsubmenus;
/*
      quick_menu[n].subitems = NULL;
      quick_menu[n].label = myscopy(quick_menu[n].label,buf);
      quick_menu[n].callback = expbuttons;
      quick_menu[n].callback_data = (void *)(EXPT_LOAD1+nquickexpts+i-1);
*/
      quick_submenu[nsubmenus][j].subitems = NULL;
      quick_submenu[nsubmenus][j].label = myscopy(quick_submenu[nsubmenus][j].label,buf);
      quick_submenu[nsubmenus][j].callback = expbuttons;
      quick_submenu[nsubmenus][j].callback_data = (void *)(EXPT_LOAD1+nquickexpts+i-1);

      sprintf(buf,"./q%dexp",i+1);
      quicknames[nquickexpts+j] = myscopy(quicknames[nquickexpts+i],buf);
      quick_menu[n+1].label = NULL;
    }
  }
  j++;
  quick_submenu[nsubmenus][j].subitems = NULL;
  quick_submenu[nsubmenus][j].label = myscopy(quick_submenu[nsubmenus][j].label,"test");
  quick_submenu[nsubmenus][j].callback = expbuttons;
  quick_submenu[nsubmenus][j].callback_data = (void *)(EXPT_LOAD1+nquickexpts+i-1);
  quicknames[nquickexpts+j] = myscopy(quicknames[nquickexpts+i],"./test.qs");


  quick_menu[nquickexpts-nallsubs+nsubmenus].subitems = quick_submenu[nsubmenus];
  quick_menu[nquickexpts-nallsubs+nsubmenus].callback_data = (void *)(nsubmenus);
  quick_menu[nquickexpts-nallsubs+nsubmenus].label = myscopy(  quick_menu[nquickexpts-nallsubs+nsubmenus].label,"Today");

  if(quick != NULL){
     XtUnmanageChild(quick);
     XtDestroyWidget(quick);
  }
  j = 0;
  for(i = 0; i < nquickexpts; i++){
    if(quick_menu[i].subitems != NULL && quick_menu[i].callback == NULL){
      //            quick_menu[i].subitems = quick_submenu[(int)quick_menu[i].callback_data];
      j = (int)quick_menu[i].callback_data;
      quick_menu[i].subitems = quick_submenu[j];
    }
  }
     quick =  my_make_menu_button(allframe,"Quick", NULL, quick_menu, 
				  estop, NEXTRIGHTWIDGET_BIT);
     fiterate(quick, NULL, NULL);
     return(quick);
}
...
val = expshoworder[menuid][k];



if(code == val){
      if(select == 0) //deselect
	expshoworder[menuid][k] = -1;
      else
	return;
    }
  }
    if(select){ //getting here means its not selected
      expshoworder[menuid][nexpshow[menuid]++] = code;
      showexp[menuid][code] = 1;
	return;
    }
/* always show "NONE" */
    showexp[2][EXPTYPE_NONE] = 1;
	
//if unselected, remove from order list
  i = 0;
  for(k = 0; k < nexpshow[menuid]; k++){
    if(expshoworder[menuid][k] >= 0){
      expshoworder[menuid][i] = expshoworder[menuid][k];
	i++;
    }
  }
  nexpshow[menuid] = i;
...
{
	Widget dialog,toggle_box,item,w,litem,rc,ritem,nitem;
	Arg args[20];
	int n = 0,i = 0,x,y,hstep,totalh,j,k;
	Dimension oh;
	Fpslider *fps;
	void toggle_callback(),stimlist_proc(),stimtoggle_callback();
	XmString str1,str,plus,times;
	float value;
	char *ctr,s[256];
	char **ntypestrings;
	int *ntypevals, all = 0;
	...
	exptset = SetExptMenu(0, all);
	ntypestrings = exptset->labels;
	ntypevals = exptset->vals;
	item = my_make_cycle(allframe,"Expt", setexp, stimcycle,
	    NEXTDOWNWIDGET_BIT, EXPTYPE, ntypestrings,ntypevals);
	XtVaSetValues(expmean[0], XmNleftWidget, item, NULL);
	fiterate(item, NULL, NULL);
	XtDestroyWidget(expcycle[0]);
	expcycle[0] = item;

	exptset = SetExptMenu(1, all);
	ntypestrings = exptset->labels;
	ntypevals = exptset->vals;	
	item = my_make_cycle(allframe,"Exp2", setsecondexp, 
	    expcycle[0], NEXTDOWNWIDGET_BIT, EXPTYPE2, ntypestrings,ntypevals);
	XtVaSetValues(expmean[1], XmNleftWidget, item, NULL);
	fiterate(item, NULL, NULL);
	XtDestroyWidget(expcycle[1]);
	expcycle[1] = item;
	SetAllPanel(&expt);
...
int AddCodesToSlider(Sliderdat *slider)
{
  ...
  while(slider[i].places >= 0)
    {
      if(slider[i].code < MAXTOTALCODES  && slider[i].label == NULL){
	sprintf(s,"%s (%s)\0",serial_names[slider[i].code],serial_strings[slider[i].code]);
	slider[i].label = (char *)malloc(sizeof(char) * (strlen(s)+1));
	strcpy(slider[i].label,s);
      }
      i++;
    }
  return(i);
...
void HideWidgetDecoration(Widget w, int up)
{
  ...
  win = XtWindow(w);
  D = XtDisplay(w);
  mwmHints = XInternAtom(D, "_MOTIF_WM_HINTS", 0);
  ...
  XtPopdown(XtParent(w));
	...
	XChangeProperty(D, win, mwmHints, mwmHints, 
		32, PropModeReplace, (unsigned char *)&hints, 4);
	XChangeProperty(D, XtWindow(XtParent(w)), mwmHints, mwmHints, 
		32, PropModeReplace, (unsigned char *)&hints, 4);
    }
  XtManageChild(w);
...
void HideFrame(Widget wi, Stimulus *st, XmAnyCallbackStruct *cbs)
{
  ...
  HideWidgetDecoration(allframe, up);
  HideWidgetDecoration(bwframe, up);
  HideWidgetDecoration(stepform, up);
  up = !up;
}
...
/*
 * This segment adds the serial codes to the  lables on the slider. Note that
 * a static string gets changed to an alloc'd pointer, which confuses malloc
 * in Linux
*/

#ifndef Linux
	AddCodesToSlider(stimsliderprops);
	AddCodesToSlider(exptsliderprops);
#endif
	if(option2flag & PSYCHOPHYSICS_BIT)
	  {
	    alloptions = GO_BIT | SEARCH_MODE_BIT | SQUARE_RDS | STIM_IN_WURTZ_BIT;
	    all2options =  FLASH_BIT | STAIRCASE | AFC | IFC;
	    allflags[FLIP_FEEDBACK] = 1;
	    allflags[FEEDBACK] = 1;
	    allflags[PAINT_BACKGROUND] = 1;
	    allflags[FIXED_BARSEP] = 1;
	    allstimflags = FLAT_DISPARITY | FLAT_SURFACES;
	  }
	else
	  {
	    alloptions = GO_BIT | STORE_WURTZ_BIT | LEFT_FIXATION_CHECK | RIGHT_FIXATION_CHECK | SEARCH_MODE_BIT | FIXATION_CHECK  | SQUARE_RDS | RAMP_HOLD_BIT | WAIT_FOR_BW_BIT;
	    all2options =  FLASH_BIT | EXPT_INTERACTIVE | INTERLEAVE_BLANK | INTERLEAVE_ONE_MONOCULAR | INTERLEAVE_UNCORRELATED | STAIRCASE | AFC;
	    allstimflags = FRONT_ONLY | HOLD_PLANE | FLAT_DISPARITY | FLAT_SURFACES;
	    allflags[INTERLEAVE_ZERO] = 1;
	  }

  n = 0;
  XtSetArg(args[n],XmNx, 10); n++;
  XtSetArg(args[n], XmNdefaultPosition, FALSE); n++;
  allframe = XmCreateForm(toplevel, "form", args, n);
  //THis seems to make item 6 on the menu destroy ALLPANEL,.
  //	clear_menu[POPDOWNI].callback_data = (void *)POPDOWN_ALLPANEL;
	if(option2flag & PSYCHOPHYSICS_BIT)
	  litem = my_make_menu_button(allframe, "Pop", NULL, ppopup_menu, NULL, 0);
	else{
	  if(nhelpfiles > 1)
	    make_helpmenu(popup_menu);
	  litem = my_make_menu_button(allframe, "Pop", NULL, popup_menu, NULL, 0);
	}

	wlist[itemcnt++] = litem;
       	item = my_make_menu_button(allframe,"Do", NULL, clear_menu,
	    litem, NEXTRIGHTWIDGET_BIT);
	wlist[itemcnt++] = item;
	item = my_make_button(allframe, "Plclear", expbuttons,
	    item, NEXTRIGHTWIDGET_BIT,CLEAR_EXPT);
	wlist[itemcnt++] = item;
	if(option2flag & PSYCHOPHYSICS_BIT)
	item = arunbutton =  my_make_button(allframe,"Run Expt", runexpt, 
	    item, NEXTRIGHTWIDGET_BIT,0);
	else
	item = arunbutton =  my_make_button(allframe,"No store", runexpt, 
	    item, NEXTRIGHTWIDGET_BIT,0);
	estop = item = my_make_button(allframe,"eStop", expt_over, 
	    item, NEXTRIGHTWIDGET_BIT,0);
	...
	if(nquickexpts == 0)
	  {
	    ...
	    memset(quick_menu, 0, (sizeof(MenuItem) * (nquickexpts+10)));
	    quick_menu[0].label = myscopy(quick_menu[0].label,"Close");
	    quick_menu[0].callback = expbuttons;
	    quick_menu[0].callback_data = (void *)(EXPT_LOAD1 -1);
	    quick_menu[0].subitems = NULL;
	    for(i = 0; i <= nquickexpts; i++)
	      {
		sprintf(s,"expt%d",i);
		quick_menu[i].label = NULL;
		quick_menu[i].label = myscopy(quick_menu[i].label,defaultexps[i]);
		quick_menu[i].callback = expbuttons;
		quick_menu[i].callback_data = (void *)(EXPT_LOAD1 + i -1);
		quick_menu[i].subitems = NULL;
		quicknames[i] = myscopy(quicknames[i],defaultexps[i]);
	      }
	    quick_menu[i].label = NULL;
	  }
	item = make_quickmenu();

	item = my_make_cycle(allframe, "FSD", bw_cycle_proc, 
		item, NEXTRIGHTWIDGET_BIT, XY_FSD, scalestrings,NULL);
	wlist[itemcnt++] = item;
	item = my_make_cycle(allframe, "O", all_cycle_proc, 
		item, NEXTRIGHTWIDGET_BIT, EYE_DOMINANCE, eyestrings,eyevals);
	wlist[itemcnt++] = item;
//Ali #ifdef macosx
	item = my_make_button(allframe,"Frame", HideFrame, 
	    item, NEXTRIGHTWIDGET_BIT,0);
//Ali #endif
/*
	item = my_make_button(allframe,"state",handle_pushbuttons,
	     item, NEXTRIGHTWIDGET_BIT, QUERY_STATE);
	item = my_make_button(allframe,"test",handle_pushbuttons,
	     item, NEXTRIGHTWIDGET_BIT, TEST_BUTTON);
*/

	stimcycle = litem = my_make_cycle(allframe,"Stim", cycle_proc, litem,
	    NEXTDOWNWIDGET_BIT, WHICHSTIM, stimstrings,whatstims);
	wlist[itemcnt++] = litem;
	item = my_make_cycle(allframe,"", cycle_proc, litem,
	    NEXTRIGHTWIDGET_BIT, STIMTYPE, stimtypestrings, stimtypevals);
	wlist[itemcnt++] = item;

#ifdef GUIMENU
       	item = my_make_menu_button(allframe,">", NULL, param_menu,
	    item, NEXTRIGHTWIDGET_BIT);
#endif

	comitem = item = my_make_text(allframe,"cmd:","", bw_text_proc, item,
	    NEXTRIGHTWIDGET_BIT, 10, COMMAND_IN);	


	str = XmStringCreateSimple("Values of even loong commands here");
	n = 0;
	XtSetArg(args[n], XmNleftAttachment, XmATTACH_WIDGET); n++;
	XtSetArg(args[n], XmNleftWidget, item); n++;
	XtSetArg(args[n], XmNbottomAttachment, XmATTACH_OPPOSITE_WIDGET); n++;
	XtSetArg(args[n], XmNbottomWidget, item); n++;
	XtSetArg(args[n], XmNlabelString, str); n++;
	cmdlabel = XmCreateLabel(allframe, "message", args, n);
	XtManageChild(cmdlabel);
	XmStringFree(str);
  	XtVaSetValues(cmdlabel, XmNrecomputeSize, FALSE, 0);
	XtManageChild(cmdlabel);

	exptset = SetExptMenu(0, 0);
	expmenustrings = ntypestrings = exptset->labels;
	ntypevals = exptset->vals;
	expcycle[0] = litem = my_make_cycle(allframe,"Expt", setexp, litem,
	    NEXTDOWNWIDGET_BIT, EXPTYPE, ntypestrings,ntypevals);
	wlist[itemcnt++] = litem;
	expmean[0] = item = my_make_text(allframe,"Mean", "", bw_text_proc,
	    litem, NEXTRIGHTWIDGET_BIT, 5, EXPT_MEAN);
	wlist[itemcnt++] = item;
	item = my_make_text(allframe,"incr", "", bw_text_proc,
	    item, NEXTRIGHTWIDGET_BIT, 5, EXPT_INCR);
	item = my_make_numeric(allframe,"nstim",numeric_proc,
	    item, NEXTRIGHTWIDGET_BIT,expt.nstim[0], 4, NTRIALS_CODE);
/*        item = my_make_cycle(allframe,"", cycle_proc, 
	    item, NEXTRIGHTWIDGET_BIT, EXPTYPE, incrstrings,NULL);
*/
	wlist[itemcnt++] = item;
	/*	item =  my_make_cycle(allframe,NULL, setsecondexp, 
	    item, NEXTRIGHTWIDGET_BIT, EXPTYPE2, modestrings, NULL);
	*/

	exptset = SetExptMenu(1, 0);
	ntypestrings = exptset->labels;
	ntypevals = exptset->vals;
	litem = expcycle[1] = my_make_cycle(allframe,"Exp2", setsecondexp, 
	    litem, NEXTDOWNWIDGET_BIT, EXPTYPE2, ntypestrings,ntypevals);
	wlist[itemcnt++] = litem;
	expmean[1] = item = my_make_text(allframe,"Mn", "", bw_text_proc,
	    litem, NEXTRIGHTWIDGET_BIT, 5, EXPT2_MEAN);
	item = my_make_text(allframe,"inc", "", bw_text_proc,
	    item, NEXTRIGHTWIDGET_BIT, 5, EXPT2_INCR);
	
	item = my_make_numeric(allframe,"nstim",numeric_proc,
	    item, NEXTRIGHTWIDGET_BIT,expt.nstim[1], 4, EXPT2_NSTIM);
	ritem = litem;
...
/*
  item = my_make_cycle(allframe,"", cycle_proc, 
	    item, NEXTRIGHTWIDGET_BIT, EXPTYPE2, incrstrings,NULL);
*/


	nrepsw = litem = my_make_numeric(allframe,"nreps", numeric_proc,
	    litem, NEXTDOWNWIDGET_BIT, expt.nreps, 4, NREPS_CODE);
	wlist[itemcnt++] = litem;
	item = my_make_numeric(allframe,"blk",numeric_proc,
	    litem, NEXTRIGHTWIDGET_BIT,expt.blksize, 4, EXPT_BLKSIZ);
	wlist[itemcnt++] = item;
/*
 * changing this is for experts! Needs chnges in nf,pr,pr, so do it
 * via a quickexpt
	item = my_make_numeric(allframe,"pack",numeric_proc,
	item, NEXTRIGHTWIDGET_BIT,expt.stimpertrial, 4, EXPT_STIMPERTRIAL);
*/
	plus = XmStringCreateSimple("+");
	times = XmStringCreateSimple("x");

	toggle_box = XmVaCreateSimpleRadioBox(allframe,"acqbox",1,
	    (XtCallbackProc)(acq_callback),
	    XmVaRADIOBUTTON, plus, NULL, NULL, NULL,
	    XmVaRADIOBUTTON, times, NULL, NULL, NULL,
	    XmNorientation, XmHORIZONTAL,
	    XmNleftAttachment, XmATTACH_WIDGET,
	    XmNleftWidget, item,
	    XmNtopAttachment, XmATTACH_WIDGET,
	    XmNtopWidget, ritem,
	    XmNuserData, ADDEXPTS_CODE,
	    NULL);
	XtManageChild(toggle_box);
	wlist[itemcnt++] = toggle_box;

	exptset = SetExptMenu(2, 1);
	ntypestrings = exptset->labels;
	ntypevals = exptset->vals;	
	item = my_make_cycle(allframe,"Exp3", setthirdexp, 
	    toggle_box, NEXTRIGHTWIDGET_BIT, EXPTYPE3, ntypestrings,ntypevals);

	item = my_make_cycle(allframe,"C", cycle_proc, 
	    item, NEXTRIGHTWIDGET_BIT, EXP3PLOT, plot3strings ,plot3vals);

	MakeMainToggle();
	sliderbox = XtVaCreateWidget("sliderbox",
	    xmRowColumnWidgetClass, allframe,
	    XmNtopAttachment, XmATTACH_WIDGET,
	    XmNtopWidget, maintoggle_box,
	    NULL);
	item = NULL;
	for(j = 0; j < NALLSLIDERS; j++)
	  {
	allfps[j] = make_multislider(sliderbox, stimsliderprops, 0, value,
	    item,
	    NEXTDOWNWIDGET_BIT,(int) 0, allfproc,allfpset,EVERYTHING_SLIDER);
	item = allfps[j]->rc;
	wlist[itemcnt++] = item;
	SetSliderType(allfps[j], allstartcode[j]);
	  }
	expslider = fps = make_multislider(sliderbox, exptsliderprops, 0, 0.0, 
  	item, NEXTDOWNWIDGET_BIT, 0, allfproc, allfpset, OTHERBITS_SLIDER);
	XtManageChild(sliderbox);
	wlist[itemcnt++] = sliderbox;

	astimlist = XmCreateScrolledList(allframe, "Astimlist", NULL, 0);
    XtVaSetValues(XtParent(astimlist), XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET,
		   XmNtopWidget, sliderbox,
		  XmNleftAttachment, XmATTACH_WIDGET,
		   XmNleftWidget, sliderbox,
		   NULL);

    XtVaSetValues(astimlist, 
		  XmNitemCount, 0,
		  XmNvisibleItemCount, 8,
		  XmNselectionPolicy, XmMULTIPLE_SELECT, 
		  NULL);
    XtAddCallback(astimlist, XmNsingleSelectionCallback, (XtCallbackProc)stimlist_proc, NULL);
    XtAddCallback(astimlist, XmNmultipleSelectionCallback, (XtCallbackProc)stimlist_proc, NULL);
    XtManageChild(astimlist);
    wlist[itemcnt++] = astimlist;

	astim2list = XmCreateScrolledList(allframe, "Astim2list", NULL, 0);
    XtVaSetValues(XtParent(astim2list), XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET,
		   XmNtopWidget, allfps[0]->rc,
		  XmNleftAttachment, XmATTACH_WIDGET,
		   XmNleftWidget, (XtParent(astimlist)),
		   NULL);

    XtVaSetValues(astim2list, 
		  XmNitemCount, 0,
		  XmNvisibleItemCount, 8,
		  XmNselectionPolicy, XmMULTIPLE_SELECT, 
		  NULL);
    XtAddCallback(astim2list, XmNsingleSelectionCallback, (XtCallbackProc)stimlist_proc, NULL);
    XtAddCallback(astim2list, XmNmultipleSelectionCallback, (XtCallbackProc)stimlist_proc, NULL);
    XtManageChild(astim2list);
    wlist[itemcnt++] = astim2list;

	XtManageChild(allframe);
	
	if(option2flag & PSYCHOPHYSICS_BIT)
	  {
	  expname = myscopy(expname,"Not named");
	  litem = my_make_text(allframe,"Experiment Name","Not Set",bw_text_proc,
	   fps->rc, NEXTDOWNWIDGET_BIT, 22, UFF_PREFIX);
	nitem = item = my_make_numeric(allframe, "Number", numeric_proc, litem,
		  NEXTRIGHTWIDGET_BIT, 0, 3, PLOT_CLUSTER);
	nitem = item = my_make_numeric(allframe, "Add", numeric_proc, nitem,
		  NEXTRIGHTWIDGET_BIT, 0, 3, PSYCH_EXPOFFSET);
	  if(expt.logfile == NULL)
	    sprintf(s,"tmp.dat");
	  else
	    sprintf(s,"%s",expt.logfile);
	  item = my_make_text(allframe,"Results File",s,bw_text_proc,
	   litem, NEXTDOWNWIDGET_BIT, 20, LOGFILE_CODE);
	  item = my_make_button(allframe,"Analyse", expbuttons, item,
				NEXTRIGHTWIDGET_BIT, ANALYZE_PSF);
	  }
	else
	  {
	item = my_make_text(allframe,"UFF prefix","C:\\bw\\data\\eyetest",bw_text_proc,
	   fps->rc, NEXTDOWNWIDGET_BIT, 25, UFF_PREFIX);
	nitem = my_make_numeric(allframe, "Cluster", bwnumeric_proc,
		  item, NEXTRIGHTWIDGET_BIT, 0, 4, PLOT_CLUSTER);
	wlist[itemcnt++] = nitem;
	  }

	numeric_set_value(nitem, 1);
	item = my_make_text(allframe,"Comment","",bw_text_proc,
	   item, NEXTDOWNWIDGET_BIT, 40, UFF_COMMENT);
	str = XmStringCreateSimple("    Initialized but initally long to make space        !!");
	n = 0;
	XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET); n++;
	XtSetArg(args[n], XmNtopWidget, item); n++;
	XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM); n++;
	XtSetArg(args[n], XmNrightAttachment, XmATTACH_FORM); n++;
	XtSetArg(args[n], XmNlabelString, str); n++;
	allstatuswidget = XmCreateLabel(allframe, "message", args, n);
	XtManageChild(allstatuswidget);
	XmStringFree(str);

	XtVaSetValues(allstatuswidget, 
		      //XmNbottomAttachment, XmATTACH_FORM,
		      XmNrecomputeSize, FALSE, 0);
/*	XtVaSetValues(form, XmNrecomputeSize, TRUE, 0);*/

	n = 0;
	allclock = XmCreateLabel(allframe, "clock", args, n);
	XtVaSetValues(allclock, XmNrightAttachment, XmATTACH_FORM,
		      XmNbottomAttachment, XmATTACH_WIDGET,
		      XmNbottomWidget, allstatuswidget, 0);
	XtManageChild(allclock);
	SetWidgetTime(allclock);
	wlist[itemcnt++] = allclock;


	str = XmStringCreateSimple("    Initialized but initally long to make space        !!");
	n = 0;
	XtSetArg(args[n], XmNtopAttachment, XmATTACH_WIDGET); n++;
	XtSetArg(args[n], XmNtopWidget, allstatuswidget); n++;
	XtSetArg(args[n], XmNleftAttachment, XmATTACH_FORM); n++;
	XtSetArg(args[n], XmNlabelString, str); n++;
	watchwidget = XmCreateLabel(allframe, "watchvals", args, n);
	XtManageChild(watchwidget);
	XmStringFree(str);
...
/*
  w = XtParent(allframe);
  HideWidgetDecoration(w);
  w = XtParent(w);
  //  HideWidgetDecoration(w);
  HideWidgetDecoration(toplevel);
*/
  XtManageChild(allframe);
  XtVaSetValues(toplevel, XmNrecomputeSize, TRUE, XmNallowShellResize, TRUE,0);
  ...
  windowlist[2] = XtWindow(maintoggle_box);
  i = 3;
  windowlist[i++] = XtWindow(allstatuswidget);
  windowlist[i++] = XtWindow(cmdlabel);
  for(j = 0; j < itemcnt; j++)
    windowlist[i++] = XtWindow(wlist[j]);
  windowlist[i] = 0;
...
void setmenu_callback(Widget item, int val, XmToggleButtonCallbackStruct *cbs)
{
  ...
  XtVaGetValues(item, XmNuserData, &menu, 0);
  if(cbs->set)
    showexp[menu][val] = 1;
  else
    showexp[menu][val] = 0;
  SelectExp(menu, val, cbs->set);
}

void PopupOptionPanel(){
	  option_popup(toggle_strings,(int)toggle_callback, winposns[OPTIONS_WIN]);
}


Widget exp_options(Widget parent, Stimulus *st, Cursor cursor)
{
	Widget dialog,toggle_box,item,w,litem,eoform;
	Arg args[20];
	int n = 0,i = 0,x,y,hstep,totalh,j,val;
	Dimension oh;
	Fpslider *fps;
	void toggle_callback(),stimlist_proc();
	char tmp[256];
	...
	eoform = XmCreateFormDialog(toplevel, "Options", args, n);
	x = 10; 
	y =5;
	item = my_make_button(eoform,"Done", FDestroyShell, NULL, 0, (int)XtParent(eoform));
	item = my_make_button(eoform,"Apply", showallexpts, item, NEXTRIGHTWIDGET_BIT, (int)XtParent(eoform));
	toggle_box = XtVaCreateWidget("togglebox",
	    xmRowColumnWidgetClass, eoform,
	    XmNtopAttachment, XmATTACH_WIDGET,
	    XmNtopWidget, item,
	    NULL);
	i = 0;
	while(firstmenu[i].label != NULL){
	  val = firstmenu[i].val;
	  sprintf(tmp,"%s (%2s)",firstmenu[i].label,serial_strings[val]);
	  w = XtVaCreateManagedWidget(tmp,
	    xmToggleButtonGadgetClass, toggle_box,
	    XmNset, (showexp[0][val])? TRUE : FALSE,
				      XmNuserData, 0,
				      NULL);
	  XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)setmenu_callback, (XtPointer)(val));
	  i++;
	}
	XtVaCreateManagedWidget("_sep", xmSeparatorGadgetClass,toggle_box, NULL);
	i = 0;
	while(secondmenu[i].label != NULL){
	  val = secondmenu[i].val;
	  sprintf(tmp,"%s (%2s)",secondmenu[i].label,serial_strings[val]);
	  w = XtVaCreateManagedWidget(tmp,
	    xmToggleButtonGadgetClass, toggle_box,
	    XmNset, (showexp[1][val])? TRUE : FALSE,
				      XmNuserData, 1,
				      NULL);
	  XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)setmenu_callback, (XtPointer)(val));
	  i++;
...
void option_popup(char **strings, int proc, Winloc pos)
{
	...
	oform = XmCreateFormDialog(toplevel, "Options", args, n);
	x = 10; 
	y =5;
	item = my_make_button(oform,"Done", FCloseShell, NULL, 0, (int)XtParent(oform));
	i = XtNumber(strings);

	str1 = XmStringCreateSimple("Goraud Shading");
	otoggle_box = XtVaCreateWidget("togglebox",
	    xmRowColumnWidgetClass, oform,
	    XmNtopAttachment, XmATTACH_WIDGET,
	    XmNtopWidget, item,
	    NULL);
	i = 0;
	while(strings[i] != NULL){
	  sprintf(tmp,"%s (%2s)",strings[i],toggle_codes[i]);
	  if(i < 32)
		w = XtVaCreateManagedWidget(tmp,
		    xmToggleButtonGadgetClass, otoggle_box,
		    XmNset, (optionflag & (1<<i)) ? TRUE : FALSE,NULL);
	...
	XtVaCreateManagedWidget("_sep", xmSeparatorGadgetClass,otoggle_box, NULL);
	i = 0;
	while(flagstrings[i] != NULL){
	  sprintf(tmp,"%s (%2s)",flagstrings[i],flag_codes[i]);
		w = XtVaCreateManagedWidget(tmp,
		    xmToggleButtonGadgetClass, otoggle_box,
		    XmNset, (stimptr->flag & (1<<i)) ? TRUE : FALSE,NULL);
...
Widget exp_popup(Widget parent, Stimulus *st, Cursor cursor)
{
	...
	Arg args[20];
	int n = 0,i = 0,x,y,hstep,totalh,j;
	Dimension oh;
	Fpslider *fps;
	void toggle_callback(),stimlist_proc();
	...
	if(exframe != NULL) /* already exists - just show */
	{
		XtManageChild(exframe);
		SetExpPanel(&expt);
		XtPopup(XtParent(exframe), XtGrabNone);
		return(exframe);
	}
	...
	n++;
	exframe = XmCreateFormDialog(parent, "expt", args, n);
/* BCNEW */
//	clear_menu[POPDOWNI].callback_data = (void *)POPDOWN_PANEL;
/* End BCNEW */
	litem = my_make_menu_button(exframe,"Clear", NULL, clear_menu,
	    NULL, 0);
	item = runbutton = my_make_button(exframe,"Run", runexpt, 
	    litem, NEXTRIGHTWIDGET_BIT,0);
	item = my_make_button(exframe,"eStop", expt_over, 
	    item, NEXTRIGHTWIDGET_BIT,0);
	item = my_make_button(exframe,"Plot", plotexptbutton, 
	    item, NEXTRIGHTWIDGET_BIT,0);
	if(nquickexpts == 0)
	  {
	    nquickexpts = 5;
	    if(quick_menu == NULL)
	      quick_menu = (MenuItem *)malloc(sizeof(MenuItem) * (200));
	memset(quick_menu, 0, (sizeof(MenuItem) * (nquickexpts+2)));
	...
	item = my_make_menu_button(exframe,"Quick", NULL, quick_menu, 
	    item, NEXTRIGHTWIDGET_BIT);
	litem = my_make_numeric(exframe,"# frames", numeric_proc, 
	    litem, NEXTDOWNWIDGET_BIT,expt.st->nframes,  4,NFRAMES_CODE);
	item = my_make_numeric(exframe,"Repititions",  numeric_proc,
	    litem, NEXTRIGHTWIDGET_BIT,expt.nreps, 3, NREPS_CODE);
	item = my_make_numeric(exframe,"# Stimuli", numeric_proc, 
	    item, NEXTRIGHTWIDGET_BIT, expt.nstim[0], 4,NTRIALS_CODE);
	value = StimulusProperty(expt.st, ORIENTATION);

	meanslider = make_fpslider(exframe, "Mean", 0.0, 360.0, 30.0, expt.plot->fplaces+1,
	    litem, (NEXTDOWNWIDGET_BIT | 1), 200, expfproc, EXPT_MEAN);

	incrslider = fps = make_fpslider(exframe, "Incr", 0.0, 180.0, expt.incr, expt.plot->fplaces+1,
	    meanslider->rc, NEXTDOWNWIDGET_BIT, 200, expfproc, EXPT_INCR);

	stimlist = XmCreateScrolledList(exframe, "Stimlist", NULL, 0);
    XtVaSetValues(XtParent(stimlist), XmNtopAttachment, XmATTACH_OPPOSITE_WIDGET,
		   XmNtopWidget, meanslider->rc,
		  XmNleftAttachment, XmATTACH_WIDGET,
		  XmNleftWidget, meanslider->rc,
		   NULL);
    XtVaSetValues(stimlist, 
		  XmNitemCount, 0,
		  XmNvisibleItemCount, 5,
		  XmNselectionPolicy, XmMULTIPLE_SELECT, 
		  NULL);
    XtAddCallback(stimlist, XmNsingleSelectionCallback, (XtCallbackProc)stimlist_proc, NULL);
    XtAddCallback(stimlist, XmNmultipleSelectionCallback, (XtCallbackProc)stimlist_proc, NULL);
    XtManageChild(stimlist);


	expslider = fps = make_multislider(exframe, sliderprops, 0, expt.postperiod, 
	    fps->rc, NEXTDOWNWIDGET_BIT, 200, expfproc, expfpset, ISI_CODE);

	toggle_box = XtVaCreateWidget("togglebox",
	    xmRowColumnWidgetClass, exframe,
	    XmNtopAttachment, XmATTACH_WIDGET,
	    XmNtopWidget, expslider->rc,
	    XmNuserData, OPTION_CODE,
	    NULL);
	...
	while(toggle_strings[i] != NULL){
		...
		XtAddCallback(w, XmNvalueChangedCallback, (XtCallbackProc)toggle_callback, (XtPointer )i);
		i++;
		if(!(option2flag & PSYCHOPHYSICS_BIT) && (1<<i) == PSYCHOPHYSICS_BIT)
		  break;
	}
	XtManageChild(toggle_box);
	XtManageChild(exframe);
	XDefineCursor(XtDisplay(exframe), XtWindow(exframe), cursor);
	
	fiterate(exframe, 0, 0);
	XtPopup(XtParent(exframe), XtGrabNone);
	SetExpPanel(&expt);
	return(exframe);
}
...
{
  int i;
  char buf[256],type[256],cbuf[256],stimname[256];
  XmString str;
  Expstim *es;
  ...
  sprintf(cbuf,"%s/%s/plot%d",datprefix,expname,trial);
  while((ifd = fopen(cbuf,"r")) != NULL)
    {
      fgets(cbuf,256,ifd);
      sscanf(cbuf,"cl %*d %s %s",type,stimname);
      fclose(ifd);
      sprintf(buf,"%d %s",trial,&cbuf[5]);
...
void ListExpStims(Widget w)
{
  ...
  for(i = 0; i < (plot->nstim[0]+plot->nstim[2]); i++, es++)
      {
	MakePlotLabel(expt.plot, buf, i, 0);
	str = XmStringCreateSimple(buf);
  ...
  */
  ...
  MakePosVisible(w,expt.nstim[0]-1);

  if(w == astimlist && astim2list != NULL)
    {
      w = astim2list;
      XmListDeleteAllItems(w);
      if(plot->nstim[1] == 0)
	{
	str = XmStringCreateSimple("N/A");
	XmListAddItemUnselected(w, str, 1);
	XmStringFree(str);
	}
...
void graphlist_proc(Widget w, XtPointer client_data, XmListCallbackStruct *cbs)
{
  ...
  MakePosVisible(list, cbs->item_position);
  sscanf(choice,"%d",&trial);
  sprintf(cbuf,"%s/%s/plot%d",datprefix,expname,trial);
  plot = ReadPlot(cbuf);
  clear_overlay();
  expt.plot = plot;
...
void stimlist_proc(Widget w, XtPointer client_data, XmListCallbackStruct *cbs)
{
  ...
  for(i = 0; i < expt.plot->nstim[0]+expt.plot->nstim[2]; i++,es++)
    es->flag &= (~BOX_ON);
  for(i = 0; i < cbs->selected_item_count; i++)
    {
    trial = cbs->selected_item_positions[i]-1;
    expt.plot->stims[trial].flag |= (BOX_ON | PSTH_ON);
  }
  clear_overlay();
  redraw_overlay(expt.plot);
}
...
void SetExpItem(Expt *ex, Widget w)
{
	...
	case STIMULUS_DURATION_CODE:
		numeric_set_value(w, ex->st->nframes);
		break;
	case NREPS_CODE:
		numeric_set_value(w, ex->nreps);
		break;
	case NFRAMES_CODE:
		...
		break;
	case NTRIALS_CODE:
		numeric_set_value(w, ex->nstim[0]);
		break;
	      case NEXT_EXPT:
		if(mode & MORE_PENDING)
		  {
		str = XmStringCreateSimple("Next");
		XtVaSetValues(w, XmNlabelString, str, NULL);
	      }
		else
		  {
		str = XmStringCreateSimple("Quick");
		XtVaSetValues(w, XmNlabelString, str, NULL);
		  }
		XmStringFree(str);
		break;
...
/* End BCNEW */
	if(expt.st->mode & EXPTPENDING)
	  ...
	  str = XmStringCreateSimple("Run Expt");
	else if(mode & UFF_FILE_OPEN && optionflag & STORE_WURTZ_BIT)
	  str = XmStringCreateSimple("Run+Store");
	else
	  str = XmStringCreateSimple("No Store");
...
void SetExpPanel(Expt *ex)
{
	...
	if(exframe == NULL)
		return;
	for(i = 0; i < expslider->nprops; i++)
		set_fpslider(expslider, expslider->proplist[i].code, ExptProperty(ex, expslider->proplist[i].code));
	set_fpslider(meanslider, 0, ex->mean);
	set_fpslider(incrslider, 0, ex->incr);
	XtVaGetValues(exframe, XmNnumChildren, &n, XmNchildren, &l, 0);
	for(i = 0; i < n; i++)
		SetExpItem(ex, l[i]);
	ListExpStims(NULL);
}
...
/* end BCNEW */
	default:
	case ISI_CODE:
		SetExptProperty(&expt, expt.st, fp->code,val);
		if(up)
		  SerialSend(fp->id);
		break;
	}
...
int SetExptProperty(Expt *exp, Stimulus *st, int flag, float val)
{
	...
	if(expslider != 0)
		set_fpslider(expslider, flag, val);
	switch(flag)
	{
	case REWARD_BIAS:
	...
	case PANEL_XPOS:
	  ...
	  if(allframe){
	    if(panelx < 1)
	      XtVaSetValues(allframe,XmNx,1,NULL);
	    else
	      XtVaSetValues(allframe,XmNx,panelx,NULL);
	  }
	  break;
	case PANEL_YPOS:
	  ...
	  if(allframe){
	    if(panely < 1)
	      XtVaSetValues(allframe,XmNy,1,NULL);
	    else
	      XtVaSetValues(allframe,XmNy,panely,NULL);
	  }
	  break;
	...
	case REWARD_SIZE2:
	case REWARD_SIZE3:
	  if(val < 1 || confirm_no("Sure you want a big reward (>1)?", NULL))
	  expt.vals[flag] = val;
	    break;
 ...
 */
	  if(exp->st->mode & EXPTPENDING){
	    if(val <= repetitions_set || exp->st->mode & EXPT_OVER){
	      ...
	      numeric_set_value(nrepsw,exp->nreps);
	  }
	  else
	    {
...
float ExptProperty(Expt *exp, int flag)
{
  ...
  switch(flag)
    ...
    case PANEL_YPOS:
      if(allframe){
	if(flag == PANEL_XPOS)
	  XtVaGetValues(allframe,XmNx,&x,NULL);
	else
	  XtVaGetValues(allframe,XmNy,&x,NULL);
	if(x > 1<<16)
	  x = (x>>16);
	if(x < 2560)
	  val = (float)x;
...
void setthirdexp(Widget w, int id, int val)
{
  ...
  optionflags[CUSTOM_EXPVALC] = 0;
	...
	case TARGET_RATIO:
	  expt.nstim[4] = 2;
	  expt.incr3 = 1-expt.vals[TARGET_RATIO];
	  expt.mean3 = (1+expt.vals[TARGET_RATIO])/2;
	  break;
	case SETCONTRAST:
	  if(optionflags[FAST_SEQUENCE]){
	    expt.nstim[4] = 1;
	    expt.vals[DISTRIBUTION_WIDTH] = 11; 
	    expt.vals[RC1INC] = 0.1;
	  }
	  else
	    expt.nstim[4] = 2;
	  break;
    case FAST_SEQUENCE_RPT:
/*
 * set default values when expt is chosen
 */
      expt.exp3vals[0] = 1;
	  expt.exp3vals[1] = 2;
	  expt.nstim[4] = 2;
	...
	case STIMULUS_TYPE_CODE:
	  expt.nstim[4] = 2;
	  expt.mean3 = (double)(STIM_RDS+STIM_RLS)/2;
	  expt.incr3 = (STIM_RLS-STIM_RDS);
	  break;
	default:
	  expt.nstim[4] = 1;
	  break;
...
int ReadCommand(char *s)
{
  ...
  if(retval >= 0){ //recognized command
      settextvalue(comitem,"");
      my_set_label(cmdlabel,command_result);
...
char *ShowTextVal(int i, char *s)
{
  ...
  if(i == MAXTOTALCODES){
    ...
    my_set_label(cmdlabel,s);
    if(new)
      settextvalue(comitem,"");
    sprintf(buf,"xx:");
    settextlabel(comitem,buf);
    return(buf);
  }
...
void bw_text_proc(Widget item, caddr_t client_data,
...
/* BCNEW */
	      case PROTRUSION:
		  sscanf(s,"%d at %d",&protrudemm,&coarsemm);
		if(penlog){
		  fprintf(penlog,"Tube Protrudes %d mm at %d mm\n",protrudemm,coarsemm);
		  fflush(penlog);
		  PrintPenLog(1);
		}
		break;
	      case IMPEDANCE:
		if(penlog){
		  fprintf(penlog,"Electrode Impedance %s\n",s);
		  fflush(penlog);
		  PrintPenLog(1);
		}
		break;
		...
		if(strstr(s,"lin"))
		  expt.flag &= (~LOGINCR);
		if(expt.flag & LOGINCR && s[0] == 'x'){
		  sscanf(&s[1],"%f",&ratio);
		  expt.incr = expt.mean * (1 - 1/ratio);
		}
		...
		if(strstr(s,"lin"))
		  expt.flag &= (~LOGINCR2);
		if(expt.flag & LOGINCR2 && s[0] == 'x'){
		  sscanf(&s[1],"%f",&ratio);
		  expt.incr2 = expt.mean2 * (1 - 1/ratio);
		}
		else
		  expt.incr2 = val;
		optionflags[CUSTOM_EXPVALB] = 0;
		...
		break;
	      case UFF_COMMENT:
		sprintf(buf,"%s=:%s\n",serial_strings[what],s);
		if(penlog){
		  fprintf(penlog,"%s %s",TimeString(),buf);
		  fflush(penlog);
		}
		if(option2flag & PSYCHOPHYSICS_BIT){
		...
		SerialString(buf,0);
		XmTextFieldSetString(item,"");
		break;
	      case UPLOAD_CODE:
		expt.upload = myscopy(expt.upload,s);
		break;
	      case BACKGROUND_IMAGE:
		expt.backprefix = myscopy(expt.backprefix,s);
		break;
	    ...
	    case UFF_PREFIX:
	      new = 1;
	      if(strcmp(nonewline(s),expt.bwptr->prefix) == NULL)
		new = 0;
	      else if(penlog)
		penetration_popup(allframe, 0, winposns[PENLOG_WIN]);
	      SetExptString(&expt, expt.st, what, s);
	      ListGraphs(gstimlist);
	...
	else if(s && strlen(s)) /* Do some operations in response to any typing */
	  {
	    switch(what)
	      {
		case UFF_PREFIX:
		  if((option2flag & PSYCHOPHYSICS_BIT))
		    expname = (char *)myscopy(expname,s);
		  break;
	      case LOGFILE_CODE:
		expt.logfile = (char *)myscopy(expt.logfile,nonewline(s));
		break;
...
void cycle_proc(Widget w, int id, int val)
{
  ...
  switch(id)
    ...
    case EXP3PLOT:
      ...
      break;
    case VWHERE:
      sprintf(cbuf,"%s=VisualArea %s\n",serial_strings[UFF_COMMENT],vstrings[val]);
	expt.vals[VWHERE] = val;
      SerialString(cbuf,0);
      if(penlog){
	fprintf(penlog,"%s VisualArea %s %s\n",TimeString(),vstrings[val],expt.bwptr->prefix);
      }
      break;
    case STIMTYPE:
      StimulusType(stimptr, val);
      mode |= NEWPOS;
      SetAllPanel(&expt);
      break;
    }
  ...
  expt.mode = val;
	...
	case DISP_P:
	  ...
	  expt.nstim[0] = 6;
		...
		set_fprange(meanslider,
		    -10.0, 10.0, expt.mean, 2);
		expt.incr = pix2deg(expt.rf->size[0])/10;
		set_fprange(incrslider,
		    -10.0, 10.0, expt.incr, 2);
		break;
	case SIDE_OFFSET:
	  expt.st->pos.phase = 0;
	  if(rdspair(expt.st))
	...
	for(i = 0; i < npts; i++)
	  {
	    ...
	    x[0] = CalcXPos(plot,j);
	    x[1] = plot->pos[1]-cw;
	    MakePlotLabel(plot,s,j,optionflags[PLOTFLIP]);
	    x[0] -= ((strlen(s) * cw)/2);
	    if(optionflags[CONTOUR_PLOT])
...
{
  int i,n = (int)data,type;
  XmString str;
  struct plotdata *plot;
  char *s,*dir,filename[256],command[256];
  Widget frame;

  switch(n)
    {
    case HELPFILE_PATH:
      help_popup(allframe, expt.helpfile);
      break;
    default:
      if(n < nhelpfiles)
	help_popup(allframe, helpfiles[n]);
      break;
    }
}
...
void expbuttons(Widget w, XtPointer data, XmAnyCallbackStruct *cbs)
{
  ...
  switch((int)data)
    ...
    case SHOW_COMMAND_HISTORY:
      cmd_popup(allframe, "binoc.history");
      break;
    case HELPFILE_PATH:
      help_popup(allframe, expt.helpfile);
      break;
    case STORE_STATE:
      ...
      break;
    case RESTORE_STATE:
      if(savevals[0][MAXTOTALCODES] > 0)
	record_setup(0,0);
      break;

    case ANALYZE_PSF:
      sprintf(command,"dat2psf -e -g -n %d %s > %s.psf",expt.plotcluster,
	      expt.logfile,expt.logfile);
      system(command);
      break;
    case POPUP_CYBER:
#ifdef Linux
      /* not happy opening ttyd1 - modem, so just send to same port. */
      cybertty = ttys[0];
#else
      if(cybertty < 0){
	if((i = OpenSerial(cyberport)) <= 0)
	  exit(-1);
	cybertty = ttys[1];
      }
#endif
      frame = cyber_popup(allframe);
      fiterate(frame,0,0);
      break;
    case POPUP_STEPPER:
#ifndef Linux
      if((frame = step_popup(allframe,stepperport, thecursor, winposns[STEPPER_WIN])) != NULL)
	fiterate(frame,0,0);
#endif
      break;
    case POPUP_GRAPHS:
      graphlist_popup(allframe);
      break;
    case RESTART_SERIAL:
      ReopenSerial();
      break;
    case EXPT_LOAD1:
    default:
      i = (int)data - EXPT_LOAD1 +1;
      if(i < MAXQUICKEXP && i <= nquickexpts+NEXPSLOTS){
	reading_quickexp = 1;
	ResetExpt();
	if(seroutfile && quicknames[i]){
	  fprintf(seroutfile,"#qe %s\n",quicknames[i]);
	  fflush(seroutfile);
	}
	if(cmdhistory && quicknames[i])
	  fprintf(cmdhistory,"#qe %s\n",quicknames[i]);
	ReadExptFile(quicknames[i],1,1,0);
      }
      break;
    case UPDATE_PANEL:
      SetExpPanel(&expt);
      break;
    case POPDOWN_PANEL:
      CloseShell(NULL,XtParent(exframe));
      break;
    case POPDOWN_ALLPANEL:
      CloseShell(NULL,XtParent(allframe));
      break;
    case CLEAR_SCREEN:
		clear_display(1);
		break;
	...
	testflags[i] = 0;
      optionflags[INTERLEAVE_MONOC_ALL] = 0;
      optionflags[INTERLEAVE_ONE_SINE] = 0;
      break;
    case CLEAR_EXPT:
      psychclear(expt.plot,1);
    case CLEAR_EXPT_ONLY:
      SavePlot(expt.plot);
      PlotClear(expt.plot);
      plotexpt(expt.plot);
      rcframe = 0;
      break;
    case CLEAR_PSYCHDATA:
      psychclear(expt.plot,1);
	break;
    case CLEAR_LINES:
      expt.nlines = 0;
    ...
    case PRINT_PLOT:
      ...
      if(optionflag & CLAMP_HOLD_BIT)
	  for(i = 0; i < 4; i++)
	    PrintCounts(plot,i,expt.plotcluster);
      else
	    PrintCounts(plot,i,expt.plotcluster);
    ...
    case PLACE_PLOT:
      ...
      break;
    case NEXT_EXPT:
      if((i = ReadExptFile(NULL, 0,0,0)) >= 0 && !(mode & WAIT_NEXT_EXPT))
	runexpt(NULL,NULL,NULL);
      break;
    case CLOSE_EXPT:
      ...
      break;
    case POPUP_PEN_LOG:
      penetration_popup(allframe, (int)data, winposns[PENLOG_WIN]);
      break;
    case POPUP_MYCODES:
    case POPUP_CODES:
    case EDIT_EXPVALS:
    case EDIT_EXP2VALS:
      expval_popup(allframe, (int)data);
      break;
    case SHOW_TRIALCOUNT:
      ShowTrialCount(0.0, -1.0);
      break;
    case POPUP_EXPT:
      exp_popup(toplevel,expt.st, thecursor);
      break;
    case EDIT_EXPMENUS:
      exp_options(toplevel,expt.st, thecursor);
      break;
    case POPUP_EXPTS:
      showallexpts(NULL);
      break;
    case POPUP_AFC:
      afc_popup(toplevel, expt.st, thecursor, winposns[AFC_WIN]);
      break;
    case POPUP_WURTZ:
	wurtz_popup(toplevel, expt.st, thecursor);
      break;
    case POPUP_BW:
      bw_popup(toplevel, thecursor, winposns[BW_WIN]);
      break;
    case POPUP_LOG:
      log_popup(toplevel, expt.st, thecursor);
      break;
    case POPUP_UNITLOG:
      unit_popup(toplevel, expt.st, thecursor);
      break;
    }
}
...
int settrialsperstim()
{
  int trials_per_stim = 1;


        if(optionflag & CLAMP_EXPT_BIT)
		trials_per_stim = 2;
	else if(option2flag & INTERLEAVE_MONOCULAR)
	      trials_per_stim = 3;
	else if(option2flag & INTERLEAVE_VERGENCE)
	  {
	    trials_per_stim = 3;
	}
	else if(option2flag & INTERLEAVE_ANTICORRELATE)
	  {
    ...
    expt.trials_per_stim = trials_per_stim;
...
int CheckKeyboard(Display *D, Widget W)
{
  ...
  if(W == NULL)
    return(0);
  win = XtWindow(W);
  if(XCheckTypedWindowEvent(D, win, KeyPress, &e)){
	res = HandleXevent(D,e);
  }
  return(res);
}
		  ...
		  if(confirmer_state && *confirmer_state == 0) /* has been acknowleged */
			...
			if(ok)
			{
			  if(msg != NULL)
				...
				w = acknowledge(s,"/bgc/bgc/c/binoc/help/SerialError");
				XtVaGetValues(w, XmNuserData, &confirmer_state, 0);
				ok = 0;
			}
...
{
	SetExptProperty(&expt,expt.st, data, (float)val);
}
...
{
  int i,j;
  Sliderdat *slider = stimsliderprops;

  for(i = 0; i < MAXTOTALCODES; i++)
    {
      if(strncmp(s, serial_strings[i], 2) ==0)
	break;
    }
  if(up == NALLSLIDERS)
    slider = exptsliderprops;
  j = 0;
  while(slider[j].label != NULL){
    if(slider[j].code == i){
      if(up == POPUP)
	PopSliderUp(allfps[NALLSLIDERS-1], i);
      else if(up == POPDOWN)
	PopSliderDown(FindSlider(allfps[NALLSLIDERS-1],i));
      else if(up < NALLSLIDERS && up >= 0)
	SetSliderType(allfps[up],i);
      else if(up == NALLSLIDERS)
	SetSliderType(expslider,i);
    }
      j++;
  }
}
...
int SetWindow()
{
	...
	XtVaGetValues(exframe, XmNchildren, &children,
	    XmNnumChildren, &numchildren, NULL);

	for(i = 0; i < numchildren; i++)
		XtVaGetValues(children[i], XmNwidth, &x, NULL);
  return(0);
}
