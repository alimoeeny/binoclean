...
ToggleCode togglestrings[] = {
  ...
  {"Cnrst Rev",    "cr",  0, CONTRAST_REVERSE_BIT, 1},
   ...
   {"PsychoPhysics",    "py", 0, PSYCHOPHYSICS_BIT, 2},
   ...
   {"+ ZeroS",    "I0", 0, INTERLEAVE_ZERO_ALL, 3},
   {"+MonocS",    "Im", 0, INTERLEAVE_MONOC_ALL, 3},
   ...
   {"Us0only",    "U0",  0, USTIM_ZERO_ONLY, 3},
   ...
   {"Odd Man Out",    "af3", 0, ODD_MAN_OU_TASK, 3},
...
ValueCode valstrings[] = {
  ...
  {"o0",    "Old Lori",OLDLEFT_ORI, 0 , 'N' ,514, SEND_EXPLICIT},
  {"o1",    "Old Rori",OLDRIGHT_ORI, 0 , 'N' ,514, SEND_EXPLICIT},
