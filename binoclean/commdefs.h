...
//  {"ul",     "UpLoad Directory*", UPLOAD_CODE, 0 , 'N' ,2, SEND_EXPLICIT},
  ...
  {"ac",     "ANTICORRELATED_DISPARITY",ANTICORRELATED_DISPARITY, 4+INDIRECT , 'N' ,3, SEND_EXPLICIT},
  ...
  {"fd",     "Fixation Overlap duration",FIXATION_OVERLAP, INDIRECT , 'N' , 3, SEND_EXPLICIT},
