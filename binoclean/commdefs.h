...
//  {"wf",     "mean fixation period",WURTZ_DURATION_CODE, 8 , 'N' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"Bc",     "Background Contrast",BACK_CONTRAST, 4+INDIRECT, 'N' ,3, SEND_READ_ONLY, SAVE_NEVER},
...
//  {"Hi", "Hidden Codes", HIDDEN_OPTIONS, 128 , 'C' ,2, SEND_EXPLICIT, SAVE_ALWAYS},
  ...
  {"verbose", "Verbosity", VERBOSE_CODE, 128 , 'N' ,2, SEND_EXPLICIT, SAVE_STATE},
    ...
    {  "fixcolors", "Fixpt colors for special tasks", FIXCOLORS, 0, 'N', 0, SEND_NEVER, SAVE_ALWAYS},
    {  "usenewdirs", "Try different targe location rules", USENEWDIRS, 0, 'N', 0, SEND_NEVER, SAVE_ALWAYS},
    {  "choicedur", "Choice target persistance", CHOICE_TARGET_DURATION, 0, 'N', 2, SEND_NEVER, SAVE_ALWAYS},
    ...
    {"onlineprefix", "Folder for online files on Mac", ONLINEPREFIX, 0, 'C', 0, SEND_NEVER, SAVE_ALWAYS},
    {"cmdfile", "File for remote commands", COMMAND_FILE, 0, 'C', 0, SEND_NEVER, SAVE_ALWAYS},
    {"psychfile", "Psych results file", PSYCHFILE, 0, 'C', 0, SEND_NEVER, SAVE_ALWAYS},
    {"impref", "prefix for image files", IMAGELOAD_PREFIX, 0, 'C', 0, SEND_EXPLICIT, SAVE_ALWAYS},
